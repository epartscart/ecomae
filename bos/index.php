    ...
    <div class="bos-main__content" id="bosContent">
        ...
        <?php
            ...
            $moduleDescriptions = array(
                ...
                'marketplace' => 'Platform marketplace: app store for tenants, install/uninstall, ratings, categories.',
                'ai_service' => 'Unified AI service: copilot, parts classification, anomaly detection, PII firewall, audit log.',
                'metabase_embed' => 'Metabase BI: embedded dashboards with signed JWT, tenant-scoped, config management.',
                'isolation_anomaly' => 'Isolation anomaly AI: cross-tenant access detection, MFA bypass alerts, risk scoring.',
