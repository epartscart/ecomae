...
2. Route inventory parity updates convert the generated owner plan from `owner-assigned-pending-parity` to implemented `aspnet-shadow`, `parity-ready`, `live`, or `removed` states.
