...
3. Presentation parity (heroes/fonts/menus) — in progress (`/marketing/app` hub+home; core nav: platform/about/faq/pricing/contact/industries; CP/ERP/BOS/storefront chrome)  
4. Function parity (writes/menus) — in progress (`POST` dry-runs across cart, OMS status/message/courier, ERP cash/GL/purchase/invoice; `aspNetInteractiveComplete=0` until human dual-sample pass)  
