...
3. Presentation parity (heroes/fonts/menus) — in progress (`/marketing/app` hub+home; platform/about/faq/pricing/contact/industries/capabilities/demo; CP/ERP/BOS/storefront chrome)  
4. Function parity (writes/menus) — in progress (`POST` dry-runs across cart, garage notepad, OMS status/message/courier, ERP cash/GL/purchase/invoice; `aspNetInteractiveComplete=0` until human dual-sample pass)  
