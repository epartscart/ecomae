...
4. Function parity (writes/menus) — in progress (`POST /storefront/cart/change-count-need` dry-run + checkout/abandoned-carts reads; `aspNetInteractiveComplete=0` until human dual-sample pass)  
