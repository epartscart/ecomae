...
| CP module ajax + classic forms | Wave C/D/E catalog: ajax leftovers + **~64** classic form POST pages (**256** actions; **174** dedicated + registry) | Live writes remain PHP; dual-sample pending |
