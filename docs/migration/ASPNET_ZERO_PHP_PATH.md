...
3. Presentation parity (heroes/fonts/menus) — in progress (`/marketing/app` hub+home; platform/about/faq/pricing/contact/industries/capabilities/demo/free-tools/platform-guides; CP/ERP/BOS/storefront chrome)  
4. Function parity (writes/menus) — in progress (`POST` dry-runs across cart/quote/garage, OMS status/message/courier, ERP cash/GL/purchase/invoice/SO; `aspNetInteractiveComplete=0` until human dual-sample pass)  
