...
| CP/storefront module ajax + classic forms | Wave C–F catalog: ajax holdouts + classic forms (**321** actions; **201** dedicated + registry) | Live writes remain PHP; dual-sample pending |
