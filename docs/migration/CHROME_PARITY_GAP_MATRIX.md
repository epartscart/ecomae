...
| Platform CP | `/CP/` | `/cp/app` · orders · users/groups/modules/pages/menus/tenants/currencies `*-app` | Hybrid: `PhpCpDesktopChrome` + registry/OMS/CMS/portal/finance read UIs | Digests ASP.NET; writes PHP | Content/menu/tenant/currency managers still PHP; tenant chrome PHP |
