...
| Platform ERP | `/ERP/` | `/erp/app` · `/erp/sales-orders-app` · `/erp/purchase-orders-app` | Hybrid: `PhpErpDesktopChrome` + SO/PO read UIs | Digests ASP.NET; SO/PO writes PHP | Full tab UIs / ajax_erp still PHP; tenant chrome PHP |
