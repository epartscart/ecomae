...
| Platform ERP | `/ERP/` | `/erp/app` · SO/PO/INV/CASH/COA/GL/WH/SUP `*-app` | Hybrid: `PhpErpDesktopChrome` + finance/inventory/AP read UIs | Digests ASP.NET; writes PHP | Full tab UIs / ajax_erp still PHP; tenant chrome PHP |
