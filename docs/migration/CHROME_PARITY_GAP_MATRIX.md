...
| Platform CP | `/CP/` | `/cp/app` · orders · users/groups/modules `*-app` | Hybrid: `PhpCpDesktopChrome` + registry/OMS read UIs | Digests ASP.NET; writes PHP | Modules manager / menus/pages still PHP; tenant chrome PHP |
