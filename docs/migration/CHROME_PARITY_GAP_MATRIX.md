...
| Platform ERP | `/ERP/` | `/erp/app` · SO/PO/INV/CASH/COA/GL `*-app` | Hybrid: `PhpErpDesktopChrome` + finance read UIs | Digests ASP.NET; writes PHP | Full tab UIs / ajax_erp still PHP; tenant chrome PHP |
