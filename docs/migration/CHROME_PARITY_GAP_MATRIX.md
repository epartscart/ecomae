...
| Platform ERP | `/ERP/` | `/erp/app` · SO/PO/INV/CASH/COA/GL/WH `*-app` | Hybrid: `PhpErpDesktopChrome` + finance/inventory read UIs | Digests ASP.NET; writes PHP | Full tab UIs / ajax_erp still PHP; tenant chrome PHP |
