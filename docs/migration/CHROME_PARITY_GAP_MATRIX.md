...
| Platform CP | `/CP/` | `/cp/app` · orders · users/groups/modules/pages `*-app` | Hybrid: `PhpCpDesktopChrome` + registry/OMS/CMS read UIs | Digests ASP.NET; writes PHP | Content manager / menus still PHP; tenant chrome PHP |
