...
| Zero-PHP end-state readiness | Phases 1–2 done; 3–4 in progress (marketing platform/about + cart/OMS/ERP write dry-runs); 5–6 blocked | — | **~48%** honest (see path board) |
