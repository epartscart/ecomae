...
| Zero-PHP end-state readiness | Phases 1–2 done; 3–4 in progress (marketing platform/about/faq + cart/OMS/ERP write dry-runs); 5–6 blocked | — | **~49%** honest (see path board) |
