...
| Zero-PHP end-state readiness | Phases 1–2 done; 3–4 in progress (core marketing nav scaffolds + cart/OMS/ERP write dry-runs); 5–6 blocked | — | **~51%** honest (see path board) |
