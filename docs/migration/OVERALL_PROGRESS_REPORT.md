...
| Zero-PHP end-state readiness | Phases 1–2 done; 3–4 in progress (marketing scaffolds + cart/quote/garage/OMS/ERP write dry-runs); 5–6 blocked | — | **~53%** honest (see path board) |
