...
| Zero-PHP end-state readiness | Phases 1–2 done; 3–4 in progress (marketing scaffolds + cart/garage/OMS/ERP write dry-runs); 5–6 blocked | — | **~52%** honest (see path board) |
