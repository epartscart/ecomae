...
3. Advance Enterprise BOS scaffolding without claiming infra live; still no production clients or Replace* flags. Operator helper: `cloudpanel_run_hybrid_ui_dual_sample_operator.sh`.
