...
3. Advance Enterprise BOS scaffolding (Postgres/Helm/OAuth/SPA options + prior stack) without claiming infra live; still no production clients or Replace* flags.
