...
| --- | ---: | --- |
| Repository foundation | 100% | ASP.NET Core solution, platform host, worker host, route constants, middleware, modules, parity reporters, PHP alias compatibility, and deterministic test scripts are present. |
...
1. Keep one final ASP.NET Core migration PR and close superseded Codex-labeled PRs using `docs/migration/OPEN_PR_CONSOLIDATION_RUNBOOK.md` and `scripts/cleanup_codex_prs.sh`.
