...
3. Advance EF Core / observability / YARP / Redis scaffolding without claiming infra live (ERP stubs + Redis options + YARP generator landed; still no AddDbContext/OTLP/YARP/Redis client).
