...
1. Finish exact-route Zero-PHP digests/parity with PHP fallback (CP meta Blazor list digests shipped through config-items → dual-sample evidence packs next).
