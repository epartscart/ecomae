...
1. Finish exact-route Zero-PHP digests/parity with PHP fallback (storefront account family through account-summary Blazor; hybrid UI dual-sample contract harness → CloudPanel live captures next).
