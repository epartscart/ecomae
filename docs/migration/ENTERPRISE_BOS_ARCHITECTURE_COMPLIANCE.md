...
1. Finish exact-route Zero-PHP digests/parity with PHP fallback (ERP inventory-stock Blazor + remaining BOS digest apps; hybrid UI dual-sample → CloudPanel live captures).
