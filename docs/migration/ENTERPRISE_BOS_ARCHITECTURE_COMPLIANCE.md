...
1. Finish exact-route Zero-PHP digests/parity with PHP fallback (continue hybrid Blazor: audit-log shipped → dual-sample evidence + remaining CP meta digests).
