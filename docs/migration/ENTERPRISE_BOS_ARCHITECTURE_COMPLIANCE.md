...
1. Finish exact-route Zero-PHP digests/parity with PHP fallback (BOS fleet-health Blazor + optional readiness; hybrid UI dual-sample → CloudPanel live captures).
