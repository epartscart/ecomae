...
1. Finish exact-route Zero-PHP digests/parity with PHP fallback (storefront account family through profile shipped; hybrid UI dual-sample contract harness → CloudPanel live captures next).
