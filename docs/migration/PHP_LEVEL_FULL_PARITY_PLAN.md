...
- ✅ Core ERP list digests through purchases + inventory-stock-app
- **This PR:** `/erp/accounts-summary-app` over `/erp/accounts-summary` digest; PHP cash/bank authoritative.
