...
This runs foundation wiring, PHP alias regression, PHP syntax, shell syntax, optional .NET tests, optional live smoke checks, and a production preflight for required commands, environment-file safety, and PHP fallback.
