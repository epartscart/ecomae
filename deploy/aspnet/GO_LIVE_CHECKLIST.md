# ASP.NET Route-by-Route Go-Live Checklist

Use this checklist for every individual ASP.NET route or surface. Do not use it to approve broad `/cp`, `/erp`, `/bos`, `/api`, or storefront catch-all traffic.

## Required evidence before changing proxy traffic

- [ ] PHP route remains healthy and rollback-tested.
- [ ] ASP.NET route responds on `127.0.0.1:5100`.
