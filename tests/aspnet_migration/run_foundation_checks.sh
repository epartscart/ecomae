...
check 'area tests assert public digests not cut over' contains "$ROOT/scripts/run_php_decommission_area_tests.sh" 'dashboard-summary-not-cutover'
...
check 'pre-removal verdict expects catalog status aspnet-json' contains "$ROOT/scripts/verify_pre_php_removal_parity.sh" 'catalog status engine unexpected'
check 'pre-removal verdict expects manufacturers aspnet-json' contains "$ROOT/scripts/verify_pre_php_removal_parity.sh" 'catalog manufacturers engine unexpected'
check 'pre-removal verdict expects models aspnet-json' contains "$ROOT/scripts/verify_pre_php_removal_parity.sh" 'catalog models engine unexpected'
check 'pre-removal verdict expects modifications aspnet-json' contains "$ROOT/scripts/verify_pre_php_removal_parity.sh" 'catalog modifications engine unexpected'
check 'pre-removal verdict expects brands aspnet-json' contains "$ROOT/scripts/verify_pre_php_removal_parity.sh" 'catalog brands engine unexpected'
check 'pre-removal verdict expects suppliers aspnet-json' contains "$ROOT/scripts/verify_pre_php_removal_parity.sh" 'catalog suppliers engine unexpected'
check 'pre-removal verdict expects vin aspnet-json' contains "$ROOT/scripts/verify_pre_php_removal_parity.sh" 'catalog vin engine unexpected'
check 'pre-removal verdict expects engines aspnet-json' contains "$ROOT/scripts/verify_pre_php_removal_parity.sh" 'catalog engines engine unexpected'
check 'pre-removal verdict expects analogs aspnet-json' contains "$ROOT/scripts/verify_pre_php_removal_parity.sh" 'catalog analogs engine unexpected'
check 'pre-removal verdict expects article-brands aspnet-json' contains "$ROOT/scripts/verify_pre_php_removal_parity.sh" 'catalog article-brands engine unexpected'
check 'pre-removal verdict expects categories aspnet-json' contains "$ROOT/scripts/verify_pre_php_removal_parity.sh" 'catalog categories engine unexpected'
check 'pre-removal verdict expects products aspnet-json' contains "$ROOT/scripts/verify_pre_php_removal_parity.sh" 'catalog products engine unexpected'
check 'pre-removal verdict expects engine-search aspnet-json' contains "$ROOT/scripts/verify_pre_php_removal_parity.sh" 'catalog engine-search engine unexpected'
