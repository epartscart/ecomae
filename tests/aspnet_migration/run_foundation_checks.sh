...
check 'area tests require live CP digests exact-route' contains "$ROOT/scripts/run_php_decommission_area_tests.sh" '/cp/dashboard-summary /cp/tenants /cp/users'
