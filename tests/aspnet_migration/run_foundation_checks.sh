...
check 'progress report exposes 37 percent complete' contains "$ROOT/aspnet/tests/EcomAE.Platform.Tests/MigrationProgressReporterTests.cs" 'Assert.Equal(37, report.OverallCompletePercent)'
