...
check 'presentation installer expects login+OMS+users/groups+ERP SO+search routes' contains "$ROOT/scripts/cloudpanel_install_presentation_app_shadows.sh" 'expected = 15'
