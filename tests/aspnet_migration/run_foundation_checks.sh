...
check 'presentation installer expects login+OMS+CP meta+audit-log+ERP+sf+bos-tenants+fleet-health routes' contains "$ROOT/scripts/cloudpanel_install_presentation_app_shadows.sh" 'expected = 41'
