...
check 'program registers tenant registry' contains "$ROOT/aspnet/src/EcomAE.Platform/Program.cs" 'AddSingleton<ITenantRegistry>'
check 'program registers configuration tenant registry seed' contains "$ROOT/aspnet/src/EcomAE.Platform/Program.cs" 'AddSingleton<ConfigurationTenantRegistry>'
check 'program can create DbBackedTenantRegistry' contains "$ROOT/aspnet/src/EcomAE.Platform/Program.cs" 'DbBackedTenantRegistry'
...
check 'YARP surface digests routeCount is 133' contains "$ROOT/deploy/aspnet/yarp-surface-digests-example.json" '"routeCount": 133'
...
check 'surface-field board contractCount is 155' contains "$ROOT/docs/migration/evidence/surface-parity/www-surface-field-parity.json" '"contractCount": 155'
check 'surface-field board includes erp process-flow-tasks' contains "$ROOT/docs/migration/evidence/surface-parity/www-surface-field-parity.json" '"aspNetRoute": "/erp/process-flow-tasks"'
...
check 'surface-digest exact-route inventory routeCount is 141' contains "$ROOT/docs/migration/evidence/surface-parity/surface-digest-exact-routes.json" '"routeCount": 141'
...
check 'digest compare-result reports 141 contracts' contains "$ROOT/docs/migration/evidence/surface-parity/digest-compare-result.json" '"contractsRegistered": 141'
...
check 'surface digest batch installer expects 133 routes' contains "$ROOT/scripts/cloudpanel_install_surface_digest_shadows.sh" 'expected 133 digest locations'
check 'surface digest batch probe expects PASS=133' contains "$ROOT/scripts/cloudpanel_probe_surface_digest_shadows.sh" 'expected 133 digest routes'
...
check 'presentation recheck evidence keeps honest soft-fail or fail' grep -Eq '"status": "(soft-fail|fail)"' "$ROOT/docs/migration/evidence/presentation/php-vs-aspnet-recheck.json"
...
check 'Wave B write dry-run probe covers ERP marketing create' contains "$ROOT/scripts/cloudpanel_probe_write_dryruns.sh" '/erp/marketing/create'
check 'Wave B write dry-run probe covers ERP subscription save' contains "$ROOT/scripts/cloudpanel_probe_write_dryruns.sh" '/erp/subscriptions/save'
check 'Wave B write dry-run probe covers ERP contract save' contains "$ROOT/scripts/cloudpanel_probe_write_dryruns.sh" '/erp/contracts/save'
check 'Wave B write dry-run probe covers ERP WMS receive' contains "$ROOT/scripts/cloudpanel_probe_write_dryruns.sh" '/erp/wms/receive'
check 'Wave B write dry-run probe covers ERP WMS location save' contains "$ROOT/scripts/cloudpanel_probe_write_dryruns.sh" '/erp/wms/locations/save'
check 'Wave B write dry-run probe covers ERP collections case save' contains "$ROOT/scripts/cloudpanel_probe_write_dryruns.sh" '/erp/collections/cases/save'
check 'Wave B write dry-run probe covers ERP procurement req save' contains "$ROOT/scripts/cloudpanel_probe_write_dryruns.sh" '/erp/procurement/requisitions/save'
check 'Wave B write dry-run probe covers ERP fin period status' contains "$ROOT/scripts/cloudpanel_probe_write_dryruns.sh" '/erp/fin/periods/status'
check 'Wave B write dry-run probe covers ERP WMS wave create' contains "$ROOT/scripts/cloudpanel_probe_write_dryruns.sh" '/erp/wms/waves/create'
check 'Wave B write dry-run probe covers ERP WMS wave release' contains "$ROOT/scripts/cloudpanel_probe_write_dryruns.sh" '/erp/wms/waves/release'
check 'Wave B write dry-run probe covers ERP WMS work complete' contains "$ROOT/scripts/cloudpanel_probe_write_dryruns.sh" '/erp/wms/work/complete'
check 'Wave B write dry-run probe covers ERP subscription status' contains "$ROOT/scripts/cloudpanel_probe_write_dryruns.sh" '/erp/subscriptions/status'
check 'Wave B write dry-run probe covers ERP collections case status' contains "$ROOT/scripts/cloudpanel_probe_write_dryruns.sh" '/erp/collections/cases/status'
check 'Wave B write dry-run probe covers ERP procurement req submit' contains "$ROOT/scripts/cloudpanel_probe_write_dryruns.sh" '/erp/procurement/requisitions/submit'
check 'Wave B write dry-run probe covers ERP procurement req decision' contains "$ROOT/scripts/cloudpanel_probe_write_dryruns.sh" '/erp/procurement/requisitions/decision'
check 'Wave B write dry-run probe covers ERP WMS location delete' contains "$ROOT/scripts/cloudpanel_probe_write_dryruns.sh" '/erp/wms/locations/delete'
...
check 'CP module ajax write catalog covers bulk upload' contains "$ROOT/aspnet/src/EcomAE.Platform/Migration/CpModuleAjaxWriteCatalog.cs" 'ajax_bulk_cp.php'
check 'CP module ajax write catalog covers prices_upload pipeline' contains "$ROOT/aspnet/src/EcomAE.Platform/Migration/CpModuleAjaxWriteCatalog.cs" 'ajax_1_prepare_tmp_dir'
check 'CP module ajax write catalog covers portal integrations' contains "$ROOT/aspnet/src/EcomAE.Platform/Migration/CpModuleAjaxWriteCatalog.cs" 'ajax_integrations.php'
...
check 'CP module ajax catalog covers pos ajax' contains "$ROOT/aspnet/src/EcomAE.Platform/Migration/CpModuleAjaxWriteCatalog.cs" 'ajax_pos.php'
check 'Wave F write dry-run probe covers pos complete_sale' contains "$ROOT/scripts/cloudpanel_probe_write_dryruns.sh" '/cp/module-ajax/pos/complete_sale/dry-run'
...
check 'hybrid inventory targetCount is 141' contains "$ROOT/docs/migration/evidence/hybrid-ui-dual-samples/php-hybrid-authoritative-inventory.json" '"targetCount": 141'
...
check 'presentation nginx has no invalid double braces' bash -c '! grep -qE "\\{\\{|}}" "$ROOT/deploy/aspnet/nginx-presentation-app-shadow-example.conf"'
check 'presentation nginx marketing/bos uses single braces' contains "$ROOT/deploy/aspnet/nginx-presentation-app-shadow-example.conf" 'location = /marketing/bos {'
check 'presentation nginx marketing/blockchain uses single braces' contains "$ROOT/deploy/aspnet/nginx-presentation-app-shadow-example.conf" 'location = /marketing/blockchain {'
check 'marketing installer refuses double braces' contains "$ROOT/scripts/cloudpanel_install_marketing_app_shadows.sh" 'invalid nginx double braces'
check 'digest capture splits customer cookie for storefront' contains "$ROOT/scripts/cloudpanel_capture_digest_dual_samples.sh" 'ECOMAE_CUSTOMER_COOKIE_HEADER'
check 'storefront digest smoke covers checkout' contains "$ROOT/tests/live_smoke/run_storefront_digest_exact_route_smoke.sh" '/storefront/checkout'
...
check 'progress json reports storefrontDigestExactRoutesWired 7' contains "$ROOT/docs/migration/inventory/zero-php-progress-status.json" '"storefrontDigestExactRoutesWired": 7'
...
check 'area tests require 133 digest inventory' contains "$ROOT/scripts/run_php_decommission_area_tests.sh" 'expected 133 digest routes'
...
check 'progress status reports surface digests 133 wired' contains "$ROOT/docs/migration/inventory/ZERO_PHP_PROGRESS_STATUS.md" '133 / 133'
check 'progress json reports surfaceDigestExactRoutesWired 133' contains "$ROOT/docs/migration/inventory/zero-php-progress-status.json" '"surfaceDigestExactRoutesWired": 133'
...
check 'classic-entry tenant example exists' test -f "$ROOT/deploy/aspnet/nginx-classic-entry-tenant-aspnet-primary-shadow-example.conf"
check 'classic-entry ASP.NET primary proxies home' contains "$ROOT/deploy/aspnet/nginx-classic-entry-aspnet-primary-shadow-example.conf" 'location = /'
...
check 'classic-entry tenant home is ASP.NET storefront' contains "$ROOT/deploy/aspnet/nginx-classic-entry-tenant-aspnet-primary-shadow-example.conf" 'proxy_pass http://127.0.0.1:5100/storefront/app'
check 'classic-entry tenant home cutover header' contains "$ROOT/deploy/aspnet/nginx-classic-entry-tenant-aspnet-primary-shadow-example.conf" 'classic-entry-tenant-home-storefront'
check 'classic-entry probe requires ASP.NET PHP-style tenant home' contains "$ROOT/scripts/cloudpanel_probe_classic_entry_aspnet_primary.sh" 'check_tenant_home_aspnet_php_style'
check 'classic-entry evidence tenant home is ASP.NET PHP-style' contains "$ROOT/docs/migration/evidence/presentation/classic-entry-aspnet-primary.json" '"homePresentation": "aspnet-php-style"'
check 'storefront preview is live ASP.NET home' contains "$ROOT/aspnet/src/EcomAE.Platform/Components/Pages/StorefrontPreviewApp.razor" 'PHP style chrome'
check 'storefront chrome has Garage Manager' contains "$ROOT/aspnet/src/EcomAE.Platform/Components/Shared/Desktop/PhpStorefrontDesktopChrome.razor" 'Garage Manager'
check 'CP shell allows guest browse' contains "$ROOT/aspnet/src/EcomAE.Platform/Components/Pages/CpCommandCentreApp.razor" 'Guest preview'
check 'ERP shell allows guest browse' contains "$ROOT/aspnet/src/EcomAE.Platform/Components/Pages/ErpBosDashboardApp.razor" 'Guest preview'
...
check 'ERP app page aliases /erp' contains "$ROOT/aspnet/src/EcomAE.Platform/Components/Pages/ErpBosDashboardApp.razor" '@page "/erp"'
check 'BOS app page aliases /bos' contains "$ROOT/aspnet/src/EcomAE.Platform/Components/Pages/BosFleetApp.razor" '@page "/bos"'
check 'php reference mode uses php-reference links' contains "$ROOT/aspnet/src/EcomAE.Platform/Migration/PhpReferenceModeReporter.cs" '/php-reference/cp'
