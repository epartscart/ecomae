...
check 'presentation installer expects login+OMS+users/groups/modules/pages/menus/tenants+audit-log+ERP SO/PO/INV/CASH/COA/GL/WH/SUP/PUR+search+cart routes' contains "$ROOT/scripts/cloudpanel_install_presentation_app_shadows.sh" 'expected = 29'
