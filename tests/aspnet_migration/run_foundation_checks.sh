...
check 'presentation installer expects login+OMS+users/groups+ERP SO/PO/INV/CASH/COA/GL+search+cart routes' contains "$ROOT/scripts/cloudpanel_install_presentation_app_shadows.sh" 'expected = 21'
