...
check 'progress report exposes 33 percent complete' contains "$ROOT/aspnet/tests/EcomAE.Platform.Tests/MigrationProgressReporterTests.cs" 'Assert.Equal(33, report.OverallCompletePercent)'
