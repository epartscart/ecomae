...
check 'presentation exact-route inventory routeCount is 168' contains "$ROOT/docs/migration/evidence/presentation/presentation-exact-routes.json" '"routeCount": 168'
...
check 'YARP design example routeCount matches presentation shadows' contains "$ROOT/deploy/aspnet/yarp-exact-routes-example.json" '"routeCount": 168'
