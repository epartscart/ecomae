...
check 'progress report exposes 46 percent complete' contains "$ROOT/aspnet/tests/EcomAE.Platform.Tests/MigrationProgressReporterTests.cs" 'Assert.Equal(46, report.OverallCompletePercent)'
