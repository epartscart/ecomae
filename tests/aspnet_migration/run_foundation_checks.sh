...
check 'progress report exposes 35 percent complete' contains "$ROOT/aspnet/tests/EcomAE.Platform.Tests/MigrationProgressReporterTests.cs" 'Assert.Equal(35, report.OverallCompletePercent)'
