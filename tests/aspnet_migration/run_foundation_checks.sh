...
check 'progress report exposes 39 percent complete' contains "$ROOT/aspnet/tests/EcomAE.Platform.Tests/MigrationProgressReporterTests.cs" 'Assert.Equal(39, report.OverallCompletePercent)'
