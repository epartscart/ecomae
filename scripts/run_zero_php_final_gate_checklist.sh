...
[[ -x "$ROOT/scripts/cloudpanel_export_final_gate_smoke_bundle.sh" ]] && record_pass "CloudPanel smoke export bundle helper executable" || record_fail "cloudpanel_export_final_gate_smoke_bundle.sh missing"
[[ -x "$ROOT/scripts/cloudpanel_push_final_gate_smoke.sh" ]] && record_pass "CloudPanel smoke token push helper executable" || record_fail "cloudpanel_push_final_gate_smoke.sh missing"
[[ -x "$ROOT/scripts/verify_pre_php_removal_parity.sh" ]] && record_pass "pre-PHP-removal parity verdict helper executable" || record_fail "verify_pre_php_removal_parity.sh missing"
...
[[ -x "$ROOT/scripts/cloudpanel_ensure_epc_api_clients_table.sh" ]] && record_pass "CloudPanel ensure epc_api_clients helper executable" || record_fail "cloudpanel_ensure_epc_api_clients_table.sh missing"
[[ -x "$ROOT/scripts/cloudpanel_issue_smoke_credentials.sh" ]] && record_pass "CloudPanel smoke credential issuer executable" || record_fail "cloudpanel_issue_smoke_credentials.sh missing"
[[ -f "$ROOT/scripts/php/issue_final_gate_smoke_credentials.php" ]] && record_pass "PHP smoke credential issuer exists" || record_fail "issue_final_gate_smoke_credentials.php missing"
[[ -f "$ROOT/scripts/php/_smoke_db_bootstrap.php" ]] && record_pass "PHP smoke DB bootstrap (DP_Config) exists" || record_fail "_smoke_db_bootstrap.php missing"
[[ -x "$ROOT/tests/live_smoke/run_storefront_digest_exact_route_smoke.sh" ]] && record_pass "storefront digest smoke runner executable" || record_fail "storefront smoke runner missing"
[[ -x "$ROOT/scripts/cloudpanel_redeploy_final_gate_branch.sh" ]] && record_pass "CloudPanel final-gate redeploy helper executable" || record_fail "cloudpanel_redeploy_final_gate_branch.sh missing"
...
[[ -f "$ROOT/scripts/compare_catalog_list_parity.py" ]] && record_pass "catalog list parity compare script exists" || record_fail "compare_catalog_list_parity.py missing"
[[ -f "$ROOT/scripts/compare_catalog_offline_cache_parity.py" ]] && record_pass "catalog offline-cache parity compare script exists" || record_fail "compare_catalog_offline_cache_parity.py missing"
[[ -f "$ROOT/scripts/compare_catalog_vin_parity.py" ]] && record_pass "catalog vin parity compare script exists" || record_fail "compare_catalog_vin_parity.py missing"
[[ -f "$ROOT/scripts/compare_catalog_brand_parts_parity.py" ]] && record_pass "catalog brand-parts parity compare script exists" || record_fail "compare_catalog_brand_parts_parity.py missing"
