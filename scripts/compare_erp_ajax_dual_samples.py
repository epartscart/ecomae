#!/usr/bin/env python3
"""Compare ERP ajax_erp dry-run dual-sample evidence. Always cutoverAllowed=false."""
...
def main() -> int:
    ...
    result = {
        ...
        "errors": errors,
        "note": "ERP ajax dry-runs are writes=0. PHP ajax_erp.php remains authoritative until dual-sample + RELEASE_OWNER_APPROVAL.md.",
    }
