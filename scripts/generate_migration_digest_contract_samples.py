    ...
    samples = {
        ...
        "erp-dashboard-summary.json": {
            **summary(
            ...
            "approvalQueue": [
                {
                    "id": "draft_so",
                    "category": "Sales",
                    "label": "1 draft sales order awaiting confirmation",
                    "count": 1,
            ...
            "readyForPhpRemoval": False,
            "note": (
                "migration-mode contract sample; approvalQueue[] item-field sentinel locked; "
                "PHP erp_dashboard / command center remains authoritative; cutoverAllowed=false"
            ),
        },
        ...
        "erp-inventory-stock.json": {
            **summary(
            ...
            "cutoverAllowed": False,
            "readyForPhpRemoval": False,
            "note": "migration-mode; stock[] + lowStock[] sentinels; PHP epc_erp_inventory.php authoritative; cutoverAllowed=false",
        },
        ...
        "erp-aging.json": {
            **summary(
            ...
            "arLabels": ["Not due", "1-30", "31-60", "61-90", "90+"],
            "apLabels": ["Not due", "1-30", "31-60", "61-90", "90+"],
            "inventoryLabels": ["0-30", "31-60", "61-90", "91-180", "180+"],
            "arRows": [{"name": "Migration customer", "bucket0": 0.0, "bucket1": 100.0, "bucket2": 0.0, "bucket3": 0.0, "bucket4": 0.0, "total": 100.0}],
            "apRows": [{"name": "Migration supplier", "bucket0": 0.0, "bucket1": 50.0, "bucket2": 0.0, "bucket3": 0.0, "bucket4": 0.0, "total": 50.0}],
            "inventoryRows": [{"name": "MIG-SKU · Migration item", "bucket0": 25.0, "bucket1": 0.0, "bucket2": 0.0, "bucket3": 0.0, "bucket4": 0.0, "total": 25.0}],
            "count": 3,
            "source": "migration",
            "message": "TenantRegistry DB is not configured.",
            "dualSampleBaseline": "migration-contract-golden",
            "cutoverAllowed": False,
            "readyForPhpRemoval": False,
            "note": "migration-mode; arRows[] sentinel from epc_erp_aging.php; PHP authoritative; cutoverAllowed=false",
        },
        "erp-stock-movements.json": {
            **summary(
                "erp",
                {
                    "movementCount": 1,
            ...
            "cutoverAllowed": False,
            "readyForPhpRemoval": False,
            "note": "migration-mode; movements[] sentinel from epc_erp_inventory_ledger; PHP authoritative; cutoverAllowed=false",
        },
        ...
        "cp-demand-intelligence.json": {
            **summary("cp", {"countryCount": 1, "articleDemandCount": 0, "priceListDemandCount": 0, "userDemandCount": 0}),
            "countries": [{"code": "ARE", "name": "United Arab Emirates", "sortOrder": 1}],
            "count": 1, "source": "migration", "message": "TenantRegistry DB is not configured.",
            "dualSampleBaseline": "migration-contract-golden", "cutoverAllowed": False, "readyForPhpRemoval": False,
            "note": "migration-mode; countries[] sentinel; PHP demand countries authoritative; cutoverAllowed=false",
        },
        "cp-credit-limits.json": {
            **summary("cp", {"limitCount": 1, "activeCount": 1, "heldCount": 0, "txnCount": 0}),
            "limits": [{"id": 1, "siteKey": "demo", "customerId": 1, "creditLimit": 10000.0, "balanceUsed": 2500.0, "currency": "AED", "status": "active", "riskScore": 40, "paymentTerms": "net30", "updatedAt": ""}],
            "count": 1, "source": "migration", "message": "TenantRegistry DB is not configured.",
            "dualSampleBaseline": "migration-contract-golden", "cutoverAllowed": False, "readyForPhpRemoval": False,
            "note": "migration-mode; limits[] sentinel; notes omitted; PHP credit limit engine authoritative; cutoverAllowed=false",
        },
        "cp-insurance-compliance.json": {
            **summary("cp", {"policyCount": 1, "activeCount": 1, "claimCount": 0, "documentCount": 0}),
            "policies": [{"id": 1, "companyId": 0, "policyNo": "POL-1", "class": "marine", "title": "Marine cargo", "insurer": "Demo Insure", "sumInsured": 100000.0, "premium": 1200.0, "currency": "AED", "expiryDate": 0, "status": "active", "timeCreated": 0}],
            "count": 1, "source": "migration", "message": "TenantRegistry DB is not configured.",
            "dualSampleBaseline": "migration-contract-golden", "cutoverAllowed": False, "readyForPhpRemoval": False,
            "note": "migration-mode; policies[] sentinel; notes/emails omitted; PHP risk insurance authoritative; cutoverAllowed=false",
        },
        "cp-audit-trail.json": {
        ...
        "cp-doc-expiry.json": {
            **summary("cp", {"documentCount": 1, "activeCount": 1, "expiredCount": 0, "reminderCount": 0}),
            "documents": [{"id": 1, "companyId": 0, "category": "legal", "docType": "trade_license", "title": "Trade license", "refNo": "TL-1", "owner": "Ops", "issuer": "DED", "expiryDate": 0, "sourceModule": "", "active": 1, "timeCreated": 0}],
            "count": 1, "source": "migration", "message": "TenantRegistry DB is not configured.",
            "dualSampleBaseline": "migration-contract-golden", "cutoverAllowed": False, "readyForPhpRemoval": False,
            "note": "migration-mode; documents[] sentinel; notes/emails omitted; PHP doc expiry authoritative; cutoverAllowed=false",
        },
        "cp-tenant-config.json": {
            **summary("cp", {"configCount": 1, "groupCount": 1, "editableCount": 1, "historyCount": 0}),
            "entries": [{"id": 1, "siteKey": "demo", "configGroup": "branding", "configKey": "company_name", "valueType": "string", "label": "Company Name", "editable": 1, "updatedBy": 0, "updatedAt": ""}],
            "count": 1, "source": "migration", "message": "TenantRegistry DB is not configured.",
            "dualSampleBaseline": "migration-contract-golden", "cutoverAllowed": False, "readyForPhpRemoval": False,
            "note": "migration-mode; entries[] sentinel; config_value omitted; PHP tenant configuration authoritative; cutoverAllowed=false",
        },
        "cp-jewellery-stock-verification.json": {
            **summary("cp", {"verificationCount": 1, "inProgressCount": 1, "completeCount": 0, "lineCount": 0}),
            "verifications": [{"id": 1, "companyId": 0, "branch": "HO", "vocType": "MSV", "vocDate": "2026-08-04", "vocNo": 1, "location": "Vault", "totalPcs": 10, "scannedPcs": 4, "remainingPcs": 6, "status": "in_progress", "createdBy": "demo"}],
            "count": 1, "source": "migration", "message": "TenantRegistry DB is not configured.",
            "dualSampleBaseline": "migration-contract-golden", "cutoverAllowed": False, "readyForPhpRemoval": False,
        ...
        "cp-geo-regions.json": {
            **summary("cp", {"nodeCount": 1, "level1Count": 1, "level2Count": 1, "mappedOfficeCount": 1}),
            "nodes": [{"id": 1, "level": 1, "parent": 1, "sortOrder": 1, "childCount": 1, "valueLangId": 1}],
            "count": 1, "source": "migration", "message": "TenantRegistry DB is not configured.",
            "dualSampleBaseline": "migration-contract-golden", "cutoverAllowed": False, "readyForPhpRemoval": False,
            "note": "migration-mode; nodes[] sentinel; raw lang string bodies; value stored as lang id; PHP Geo / regions remains authoritative; cutoverAllowed=false",
        },
        "cp-product-filters.json": {
            **summary("cp", {"filterCount": 1, "withStorageScope": 1, "withPriceBand": 1, "withTimeBand": 1}),
            "filters": [{"id": 1, "manufacturer": "migration", "article": "migration", "name": "migration", "minPrice": 0.0, "maxPrice": 0.0, "minTime": 1, "maxTime": 1}],
            "count": 1, "source": "migration", "message": "TenantRegistry DB is not configured.",
            "dualSampleBaseline": "migration-contract-golden", "cutoverAllowed": False, "readyForPhpRemoval": False,
            "note": "migration-mode; filters[] sentinel; list_storages JSON; PHP Product filters remains authoritative; cutoverAllowed=false",
        },
        "cp-search-tabs.json": {
            **summary("cp", {"tabCount": 1, "enabledCount": 1, "disabledCount": 1, "maxOrder": 1}),
            "tabs": [{"id": 1, "caption": "migration", "sortOrder": 1, "enabled": 1}],
            "count": 1, "source": "migration", "message": "TenantRegistry DB is not configured.",
            "dualSampleBaseline": "migration-contract-golden", "cutoverAllowed": False, "readyForPhpRemoval": False,
            "note": "migration-mode; tabs[] sentinel; parameters_values JSON; PHP Search tabs remains authoritative; cutoverAllowed=false",
        },
        "cp-system-requests.json": {
            **summary("cp", {"requestCount": 1, "unviewedCount": 1, "viewedCount": 1, "withUserCount": 1}),
            "requests": [{"id": 1, "timeUnix": 1, "userId": 1, "viewed": 1}],
            "count": 1, "source": "migration", "message": "TenantRegistry DB is not configured.",
            "dualSampleBaseline": "migration-contract-golden", "cutoverAllowed": False, "readyForPhpRemoval": False,
            "note": "migration-mode; requests[] sentinel; VIN request text body (injection-prone PHP cookie filters not ported); PHP System requests remains authoritative; cutoverAllowed=false",
        },
        "cp-additional-texts.json": {
            **summary("cp", {"textCount": 1, "beforeMainCount": 1, "withTitleCount": 1, "withDescriptionCount": 1}),
            "texts": [{"id": 1, "url": "migration", "beforeMain": 1, "titleTag": "migration", "keywordsTag": "migration"}],
            "count": 1, "source": "migration", "message": "TenantRegistry DB is not configured.",
            "dualSampleBaseline": "migration-contract-golden", "cutoverAllowed": False, "readyForPhpRemoval": False,
            "note": "migration-mode; texts[] sentinel; content HTML + description_tag bodies in rows (title/keywords only); PHP Additional texts remains authoritative; cutoverAllowed=false",
        },
        "cp-slider-banners.json": {
            **summary("cp", {"imageCount": 1, "connected": 1, "cntImg": 1, "cntImgNext": 1}),
            "images": [{"id": 1, "sortOrder": 1, "link": "migration", "href": "migration"}],
            "count": 1, "source": "migration", "message": "TenantRegistry DB is not configured.",
            "dualSampleBaseline": "migration-contract-golden", "cutoverAllowed": False, "readyForPhpRemoval": False,
            "note": "migration-mode; images[] sentinel; none critical (paths only); PHP Slider / banners remains authoritative; cutoverAllowed=false",
        },
        "cp-structure-dumps.json": {
            **summary("cp", {"dumpCount": 1, "totalRecords": 1, "latestTimeCreated": 1, "withFileCount": 1}),
            "dumps": [{"id": 1, "timeCreated": 1, "fieldsInDump": "migration", "fileName": "migration", "recordsCount": 1}],
            "count": 1, "source": "migration", "message": "TenantRegistry DB is not configured.",
            "dualSampleBaseline": "migration-contract-golden", "cutoverAllowed": False, "readyForPhpRemoval": False,
            "note": "migration-mode; dumps[] sentinel; dump file bodies; PHP Structure dumps remains authoritative; cutoverAllowed=false",
        },
        "cp-communications-test.json": {
            **summary("cp", {"smsActiveCount": 1, "smsTotalCount": 1, "emailLastStatus": "", "smsLastStatus": ""}),
            "channels": [{"name": "migration", "active": 1, "isSelectable": 1, "handler": "migration"}],
            "count": 1, "source": "migration", "message": "TenantRegistry DB is not configured.",
            "dualSampleBaseline": "migration-contract-golden", "cutoverAllowed": False, "readyForPhpRemoval": False,
            "note": "migration-mode; channels[] sentinel; debug_result blobs + sms parameters_values secrets; PHP Communications test remains authoritative; cutoverAllowed=false",
        },
        "cp-languages.json": {
            **summary("cp", {"languageCount": 1, "activeCount": 1, "defaultCount": 1, "inactiveCount": 1}),
            "languages": [{"langCode": "migration", "active": 1, "isDefault": 1}],
            "count": 1, "source": "migration", "message": "TenantRegistry DB is not configured.",
            "dualSampleBaseline": "migration-contract-golden", "cutoverAllowed": False, "readyForPhpRemoval": False,
            "note": "migration-mode; languages[] sentinel; translation string bodies; PHP Languages remains authoritative; cutoverAllowed=false",
        },
        "cp-plugins-manager.json": {
            **summary("cp", {"pluginCount": 1, "activatedCount": 1, "frontendCount": 1, "lockedCount": 1}),
            "plugins": [{"id": 1, "caption": "migration", "sortOrder": 1, "activated": 1, "isFrontend": 1, "controlLock": 1}],
            "count": 1, "source": "migration", "message": "TenantRegistry DB is not configured.",
            "dualSampleBaseline": "migration-contract-golden", "cutoverAllowed": False, "readyForPhpRemoval": False,
            "note": "migration-mode; plugins[] sentinel; data_value JSON + filesystem delete side-effects; PHP Plugins manager remains authoritative; cutoverAllowed=false",
        },
        "cp-templates-manager.json": {
            **summary("cp", {"templateCount": 1, "frontendCount": 1, "currentFrontendCount": 1, "currentBackendCount": 1}),
            "templates": [{"id": 1, "caption": "migration", "name": "migration", "current": 1, "isFrontend": 1, "phoneSupport": 1, "tabletSupport": 1}],
            "count": 1, "source": "migration", "message": "TenantRegistry DB is not configured.",
            "dualSampleBaseline": "migration-contract-golden", "cutoverAllowed": False, "readyForPhpRemoval": False,
            "note": "migration-mode; templates[] sentinel; data_value JSON + FS delete; PHP Templates manager remains authoritative; cutoverAllowed=false",
        },
        "cp-design-tokens.json": {
            **summary("cp", {"tokenCount": 1, "tenantCount": 1, "whiteLabelCount": 1, "updatedRecentCount": 1}),
            "tokens": [{"siteKey": "migration", "settingKey": "migration", "updatedAt": "migration"}],
            "count": 1, "source": "migration", "message": "TenantRegistry DB is not configured.",
            "dualSampleBaseline": "migration-contract-golden", "cutoverAllowed": False, "readyForPhpRemoval": False,
            "note": "migration-mode; tokens[] sentinel; setting_value (colors/URLs); ASP.NET also tolerates missing site_key via resilient KPIs; PHP Design tokens remains authoritative; cutoverAllowed=false",
        },
        "cp-sitemap.json": {
            **summary("cp", {"contentUrlCount": 1, "categoryCount": 1, "productCount": 1, "frontendContentCount": 1}),
            "pages": [{"id": 1, "alias": "migration", "valueLangId": 1, "isFrontend": 1, "publishedFlag": 1}],
            "count": 1, "source": "migration", "message": "TenantRegistry DB is not configured.",
            "dualSampleBaseline": "migration-contract-golden", "cutoverAllowed": False, "readyForPhpRemoval": False,
            "note": "migration-mode; pages[] sentinel; sitemap.xml file artifact (generation remains PHP); content HTML omitted; PHP Sitemap remains authoritative; cutoverAllowed=false",
        },
        "cp-failover-status.json": {
            **summary("cp", {"modeFilePresent": 1, "statusJsonPresent": 1, "configPresent": 1, "backupMode": 1}),
            "signals": [{"path": "migration", "present": 1, "kind": "migration"}],
            "count": 1, "source": "migration", "message": "TenantRegistry DB is not configured.",
            "dualSampleBaseline": "migration-contract-golden", "cutoverAllowed": False, "readyForPhpRemoval": False,
            "note": "migration-mode; secrets inside failover config; PHP Failover status remains authoritative; cutoverAllowed=false",
        },
        "cp-ops-guides.json": {
            **summary("cp", {"groupCount": 1, "itemCount": 1, "showAnywayCount": 1, "urlItemCount": 1}),
            "items": [{"id": 1, "itemsGroup": 1, "caption": "migration", "url": "migration", "showAnyway": 1, "sortOrder": 1}],
            "count": 1, "source": "migration", "message": "TenantRegistry DB is not configured.",
            "dualSampleBaseline": "migration-contract-golden", "cutoverAllowed": False, "readyForPhpRemoval": False,
            "note": "migration-mode; items[] sentinel; guide HTML bodies; PHP Ops guides remains authoritative; cutoverAllowed=false",
        },
        "cp-file-manager.json": {
            **summary("cp", {"rootPresent": 1, "fileCount": 1, "dirCount": 1, "totalBytes": 1}),
            "entries": [{"name": "migration", "isDirectory": 1, "sizeBytes": 1, "extension": "migration"}],
            "count": 1, "source": "migration", "message": "TenantRegistry DB is not configured.",
            "dualSampleBaseline": "migration-contract-golden", "cutoverAllowed": False, "readyForPhpRemoval": False,
            "note": "migration-mode; entries[] sentinel; file contents; PHP File manager remains authoritative; cutoverAllowed=false",
        },
        "cp-server-ip.json": {
            **summary("cp", {"addressCount": 1, "hasIpv4": 1, "hasIpv6": 1, "loopbackOnly": 1}),
            "addresses": [{"address": "migration", "addressFamily": "migration", "isLoopback": 1}],
            "count": 1, "source": "migration", "message": "TenantRegistry DB is not configured.",
            "dualSampleBaseline": "migration-contract-golden", "cutoverAllowed": False, "readyForPhpRemoval": False,
