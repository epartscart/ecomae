...
ERP_TAB_HYBRID_BY_ID = {
    ...
    ("service_mgmt", "jw_repairs"): "cp-jewellery-retail",
    ("service_mgmt", "jw_repair_receipt"): "cp-jewellery-retail",
    ("service_mgmt", "jw_repair_transfer"): "cp-jewellery-retail",
    ("service_mgmt", "jw_workshop_receive"): "cp-jewellery-retail",
    ("service_mgmt", "jw_repair_delivery"): "cp-jewellery-retail",
    ("service_mgmt", "jw_repair_sale"): "cp-jewellery-retail",
    ("service_mgmt", "jw_repair_register"): "cp-jewellery-retail",
    ("service_mgmt", "jw_repair_search"): "cp-jewellery-retail",
