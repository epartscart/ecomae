...
#   set -euxo pipefail
#   URL='https://raw.githubusercontent.com/epartscart/ecomae/TIP_SHA/scripts/cloudpanel_EPARTSCART_CHPU_SKU_MEDIA_NOW.sh'
...
ECOMAE_BRANCH="${ECOMAE_BRANCH:-cursor/chpu-sku-media-spec-photo-7529}"
...
grep -q '20260812-skumedia' aspnet/src/EcomAE.Platform/Components/Pages/StorefrontSearchApp.razor \
  || die "missing skumedia cache bust"
