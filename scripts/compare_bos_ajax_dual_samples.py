#!/usr/bin/env python3
"""Compare BOS ajax dry-run dual-sample evidence.
...
def main() -> int:
    ...
    result = {
        ...
        "note": (
            "BOS ajax dry-runs are writes=0. Contract-only pairs use migration-contract-golden "
            "baselines — not live PHP. PHP bos/ajax remains authoritative until field "
    ...
    if errors:
        ...
        return 1
    print(
        f"PASS: bos-ajax dual-sample compare cutoverAllowed=false "
