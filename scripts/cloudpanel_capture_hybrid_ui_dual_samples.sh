...
TARGETS = [
    ...
    ("cp-landed-cost", "cp", "/cp/landed-cost-app", "/cp/landed-cost", "/ERP/?epc_erp_shell=1&area=landed_cost_area&tab=landed_cost", "CpLandedCostApp", "PhpCpDesktopChrome", "admin"),
    ("cp-warehouse-wms", "cp", "/cp/warehouse-wms-app", "/cp/warehouse-wms", "/ERP/?epc_erp_shell=1&area=warehouse&tab=wms", "CpWarehouseWmsApp", "PhpCpDesktopChrome", "admin"),
    ("cp-ai-service", "cp", "/cp/ai-service-app", "/cp/ai-service", "/CP/general_pages/epc_ai_service", "CpAiServiceApp", "PhpCpDesktopChrome", "admin"),
    ("cp-returns-rma", "cp", "/cp/returns-rma-app", "/cp/returns-rma", "/CP/shop/returns-manager", "CpReturnsRmaApp", "PhpCpDesktopChrome", "admin"),
    ("cp-isolation-audit", "cp", "/cp/isolation-audit-app", "/cp/isolation-audit", "/CP/control/portal/epc_commerce_isolation_audit", "CpIsolationAuditApp", "PhpCpDesktopChrome", "admin"),
    ("cp-aml-compliance", "cp", "/cp/aml-compliance-app", "/cp/aml-compliance", "/ERP/?epc_erp_shell=1&area=tax&tab=aml_compliance", "CpAmlComplianceApp", "PhpCpDesktopChrome", "admin"),
    ("cp-jewellery-masters", "cp", "/cp/jewellery-masters-app", "/cp/jewellery-masters", "/ERP/?epc_erp_shell=1&area=inventory_mgmt&tab=jw_karat", "CpJewelleryMastersApp", "PhpCpDesktopChrome", "admin"),
    ("cp-consolidations", "cp", "/cp/consolidations-app", "/cp/consolidations", "/ERP/?epc_erp_shell=1&area=consolidations&tab=consolidation_bu", "CpConsolidationsApp", "PhpCpDesktopChrome", "admin"),
    ("cp-crm-activities", "cp", "/cp/crm-activities-app", "/cp/crm-activities", "/CP/shop/crm/crm_main?tab=activities", "CpCrmActivitiesApp", "PhpCpDesktopChrome", "admin"),
    ("cp-auth-mfa", "cp", "/cp/auth-mfa-app", "/cp/auth-mfa", "/CP/control/portal/epc_cp_auth_settings", "CpAuthMfaApp", "PhpCpDesktopChrome", "admin"),
    ("cp-electronic-reporting", "cp", "/cp/electronic-reporting-app", "/cp/electronic-reporting", "/ERP/?epc_erp_shell=1&area=tax&tab=elec_reporting", "CpElectronicReportingApp", "PhpCpDesktopChrome", "admin"),
    ("cp-collections-dunning", "cp", "/cp/collections-dunning-app", "/cp/collections-dunning", "/CP/shop/finance/epc_collections_dunning", "CpCollectionsDunningApp", "PhpCpDesktopChrome", "admin"),
    ("cp-marketplace-channels", "cp", "/cp/marketplace-channels-app", "/cp/marketplace-channels", "/CP/shop/channels/channels_main", "CpMarketplaceChannelsApp", "PhpCpDesktopChrome", "admin"),
    ("cp-demand-intelligence", "cp", "/cp/demand-intelligence-app", "/cp/demand-intelligence", "/CP/shop/demand_countries", "CpDemandIntelligenceApp", "PhpCpDesktopChrome", "admin"),
    ("cp-credit-limits", "cp", "/cp/credit-limits-app", "/cp/credit-limits", "/CP/shop/finance/epc_credit_limit", "CpCreditLimitsApp", "PhpCpDesktopChrome", "admin"),
    ("cp-insurance-compliance", "cp", "/cp/insurance-compliance-app", "/cp/insurance-compliance", "/ERP/?epc_erp_shell=1&area=risk&tab=insurance", "CpInsuranceComplianceApp", "PhpCpDesktopChrome", "admin"),
    ("cp-audit-trail", "cp", "/cp/audit-trail-app", "/cp/audit-trail", "/ERP/?epc_erp_shell=1&area=audit_wb&tab=audit", "CpAuditTrailApp", "PhpCpDesktopChrome", "admin"),
    ("cp-doc-expiry", "cp", "/cp/doc-expiry-app", "/cp/doc-expiry", "/ERP/?epc_erp_shell=1&area=risk&tab=doc_expiry", "CpDocExpiryApp", "PhpCpDesktopChrome", "admin"),
    ("cp-tenant-config", "cp", "/cp/tenant-config-app", "/cp/tenant-config", "/ERP/?epc_erp_shell=1&area=setup&tab=tenant_config", "CpTenantConfigApp", "PhpCpDesktopChrome", "admin"),
    ("cp-jewellery-stock-verification", "cp", "/cp/jewellery-stock-verification-app", "/cp/jewellery-stock-verification", "/ERP/?epc_erp_shell=1&area=inventory_mgmt&tab=jw_stock_verification", "CpJewelleryStockVerificationApp", "PhpCpDesktopChrome", "admin"),
    ("cp-tax-external-reporting", "cp", "/cp/tax-external-reporting-app", "/cp/tax-external-reporting", "/ERP/?epc_erp_shell=1&area=tax&tab=ext_reports", "CpTaxExternalReportingApp", "PhpCpDesktopChrome", "admin"),
    ("cp-po-approvals", "cp", "/cp/po-approvals-app", "/cp/po-approvals", "/CP/shop/finance/epc_po_approval", "CpPoApprovalsApp", "PhpCpDesktopChrome", "admin"),
    ("cp-finance-close", "cp", "/cp/finance-close-app", "/cp/finance-close", "/ERP/?epc_erp_shell=1&area=finance&tab=opening_balances", "CpFinanceCloseApp", "PhpCpDesktopChrome", "admin"),
    ("cp-jewellery-fixing", "cp", "/cp/jewellery-fixing-app", "/cp/jewellery-fixing", "/ERP/?epc_erp_shell=1&area=purchasing&tab=jw_purchase_fixing", "CpJewelleryFixingApp", "PhpCpDesktopChrome", "admin"),
    ("cp-web-tracker", "cp", "/cp/web-tracker-app", "/cp/web-tracker", "/CP/control/portal/epc_web_tracker", "CpWebTrackerApp", "PhpCpDesktopChrome", "admin"),
    ("cp-free-tools", "cp", "/cp/free-tools-app", "/cp/free-tools", "/CP/control/portal/epc_free_tools_admin", "CpFreeToolsApp", "PhpCpDesktopChrome", "admin"),
    ...
    ("cp-geo-regions", "cp", "/cp/geo-regions-app", "/cp/geo-regions", "/CP/shop/geo/nodes", "CpGeoRegionsApp", "PhpCpDesktopChrome", "admin"),
    ("cp-product-filters", "cp", "/cp/product-filters-app", "/cp/product-filters", "/CP/shop/filter", "CpProductFiltersApp", "PhpCpDesktopChrome", "admin"),
    ("cp-search-tabs", "cp", "/cp/search-tabs-app", "/cp/search-tabs", "/CP/shop/taby-poiska", "CpSearchTabsApp", "PhpCpDesktopChrome", "admin"),
    ("cp-system-requests", "cp", "/cp/system-requests-app", "/cp/system-requests", "/CP/requests", "CpSystemRequestsApp", "PhpCpDesktopChrome", "admin"),
    ("cp-additional-texts", "cp", "/cp/additional-texts-app", "/cp/additional-texts", "/CP/content/dopolnitelnye-teksty", "CpAdditionalTextsApp", "PhpCpDesktopChrome", "admin"),
    ("cp-slider-banners", "cp", "/cp/slider-banners-app", "/cp/slider-banners", "/CP/content/slider", "CpSliderBannersApp", "PhpCpDesktopChrome", "admin"),
    ("cp-structure-dumps", "cp", "/cp/structure-dumps-app", "/cp/structure-dumps", "/CP/content/structure_dumps", "CpStructureDumpsApp", "PhpCpDesktopChrome", "admin"),
    ("cp-communications-test", "cp", "/cp/communications-test-app", "/cp/communications-test", "/CP/control/communications", "CpCommunicationsTestApp", "PhpCpDesktopChrome", "admin"),
    ("cp-languages", "cp", "/cp/languages-app", "/cp/languages", "/CP/lang", "CpLanguagesApp", "PhpCpDesktopChrome", "admin"),
    ("cp-plugins-manager", "cp", "/cp/plugins-manager-app", "/cp/plugins-manager", "/CP/plugins/plugins_manager", "CpPluginsManagerApp", "PhpCpDesktopChrome", "admin"),
    ("cp-templates-manager", "cp", "/cp/templates-manager-app", "/cp/templates-manager", "/CP/templates/templates_manager", "CpTemplatesManagerApp", "PhpCpDesktopChrome", "admin"),
    ("cp-design-tokens", "cp", "/cp/design-tokens-app", "/cp/design-tokens", "/CP/control/portal/epc_design_tokens", "CpDesignTokensApp", "PhpCpDesktopChrome", "admin"),
    ("cp-sitemap", "cp", "/cp/sitemap-app", "/cp/sitemap", "/CP/content/sitemap", "CpSitemapApp", "PhpCpDesktopChrome", "admin"),
    ("cp-failover-status", "cp", "/cp/failover-status-app", "/cp/failover-status", "/CP/control/portal/epc_platform_failover_guide", "CpFailoverStatusApp", "PhpCpDesktopChrome", "admin"),
