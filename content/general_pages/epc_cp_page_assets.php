...
function epc_cp_page_asset_url_map(): array
{
	...
	return array(
		...
		'shop/statistics/web_tracker' => array(
			'css' => array('/content/general_pages/epc_web_tracker_cp_css.php?v=' . rawurlencode($ver . 'wt5')),
			'js' => array(
				'/' . $backend . '/content/control/portal/epc_web_tracker_config.php?v=' . rawurlencode($ver . 'wt5'),
				'/' . $backend . '/content/control/portal/epc_web_tracker_cp.js?v=' . rawurlencode($ver . 'wt5'),
			),
		),
