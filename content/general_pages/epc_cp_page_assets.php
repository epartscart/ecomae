	...
	return array(
		...
		'shop/orders/orders' => array(
			'css' => array(
				...
				'/lib/multiple_select/multiple-select.css',
				'/' . $backend . '/content/users/statistics/assets/modal.css',
				'/content/general_pages/epc_orders_cp_css.php?v=' . rawurlencode($ver . 'omsParity4'),
			),
			'js' => array(
				'/lib/datetimepicker/jquery.datetimepicker.js',
				'/lib/multiple_select/jquery.multiple.select.js',
				'/' . $backend . '/content/users/statistics/assets/main.js',
				'/' . $backend . '/content/shop/order_process/orders_config.php?v=' . rawurlencode($ver . 'omsParity4')
					. (isset($_GET['order_id']) ? '&order_id=' . (int) $_GET['order_id'] : '')
					. (isset($_GET['status_id']) ? '&status_id=' . (int) $_GET['status_id'] : ''),
				'/' . $backend . '/content/shop/order_process/orders_cp.js?v=' . rawurlencode($ver . 'omsParity4'),
				'/' . $backend . '/content/shop/order_process/epc_orders_fulfillment.js?v=' . rawurlencode($ver . 'omsParity4'),
			),
		),
