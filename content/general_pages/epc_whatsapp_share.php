...
function epc_wa_styles(): string
{
	return '<style>'
		...
		. '.epc-product-actions__tools,.epc-product-actions__buy{display:inline-flex;flex-wrap:nowrap;gap:8px;align-items:center;justify-content:flex-start;width:auto;flex:0 0 auto;}'
