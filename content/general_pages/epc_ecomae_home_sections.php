	...
	<section id="industries" class="ehm-sec">
		<div class="ehm-wrap">
			...
			<div class="ehm-ind-grid ehm-rev">
				<a class="ehm-ind-card" href="<?php echo $h($industriesUrl); ?>/auto_parts" style="text-decoration:none;color:inherit"><span class="ehm-ind-emo">🔧</span><div class="ehm-ind-name">Auto Parts</div><div class="ehm-ind-sub">VIN · OEM · B2B</div><span class="ehm-live-tag">● Live</span></a>
				<a class="ehm-ind-card" href="<?php echo $h($industriesUrl); ?>/fashion" style="text-decoration:none;color:inherit"><span class="ehm-ind-emo">👗</span><div class="ehm-ind-name">Fashion &amp; Beauty</div><div class="ehm-ind-sub">Variants · Lookbooks</div><span class="ehm-live-tag">● Live</span></a>
				<a class="ehm-ind-card" href="<?php echo $h($industriesUrl); ?>/electronics" style="text-decoration:none;color:inherit"><span class="ehm-ind-emo">📱</span><div class="ehm-ind-name">Electronics</div><div class="ehm-ind-sub">SKU-heavy · RMA</div><span class="ehm-live-tag">● Live</span></a>
				<a class="ehm-ind-card" href="<?php echo $h($industriesUrl); ?>/jewellery" style="text-decoration:none;color:inherit"><span class="ehm-ind-emo">💎</span><div class="ehm-ind-name">Jewellery</div><div class="ehm-ind-sub">Gallery · Certs</div><span class="ehm-live-tag">● Live</span></a>
				...
				<a class="ehm-ind-card" href="<?php echo $h($industriesUrl); ?>/tax_advisory" style="text-decoration:none;color:inherit"><span class="ehm-ind-emo">📋</span><div class="ehm-ind-name">Tax &amp; Advisory</div><div class="ehm-ind-sub">CRM · VAT · Docs</div><span class="ehm-live-tag">● Live</span></a>
