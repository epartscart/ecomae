	...
	<section id="features" class="ehm-sec ehm-sec--alt">
		<div class="ehm-wrap">
			...
			<div class="ehm-feat-grid">
				...
				<div class="ehm-fc ehm-rev ehm-rev--2"><div class="ehm-fc-ico">🔗</div><h4>Blockchain Proof</h4><p>Hash critical invoices, GRNs, RMAs and certificates; Merkle-anchor batches; verify authenticity publicly — enterprise trust built into the BOS. <a href="/epc-blockchain-verify.php" style="color:var(--ehm-m)">Verify a proof →</a></p><div class="ehm-pills"><span class="ehm-pill">SHA-256 Proofs</span><span class="ehm-pill">Merkle Anchor</span><span class="ehm-pill">Public Verify</span></div></div>
