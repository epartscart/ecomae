<?php
/**
 * Jewellery & Luxury Goods — Industry Template
...
$industryData = array(
	...
	'tagline' => 'Gold trading + gemstone tracking + hallmarking',
	...
	'hero_photo' => 'https://images.unsplash.com/photo-1515562141589-67f0d72cec37?w=1600&q=80',
	'gallery_photos' => array(
		'https://images.unsplash.com/photo-1601121141461-9d6647bca1ed?w=600&q=75',
		'https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?w=600&q=75',
		'https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=600&q=75',
		'https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=600&q=75',
		'https://images.unsplash.com/photo-1603561591411-07134e71a2a9?w=600&q=75',
	),
	'demo_key' => 'jewellery_luxury',
	'product_label' => 'Products & Services',
	'sample_products' => array(
		array('name' => '22K Gold Necklace', 'price' => 'AED 8,500', 'icon' => 'fa-diamond', 'category' => 'Gold', 'image' => 'https://images.unsplash.com/photo-1602173574767-37ac01994b2a?w=400&q=75'),
		array('name' => 'Diamond Solitaire Ring', 'price' => 'AED 15,000', 'icon' => 'fa-star', 'category' => 'Diamond', 'image' => 'https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=400&q=75'),
		array('name' => 'Rolex Datejust', 'price' => 'AED 42,000', 'icon' => 'fa-clock-o', 'category' => 'Watches', 'image' => 'https://images.unsplash.com/photo-1617038220319-276d3cfab638?w=400&q=75'),
		array('name' => 'Pearl Earrings', 'price' => 'AED 1,200', 'icon' => 'fa-circle', 'category' => 'Pearls', 'image' => 'https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=400&q=75'),
		array('name' => 'Custom Design Service', 'price' => 'From AED 500', 'icon' => 'fa-pencil', 'category' => 'Bespoke', 'image' => 'https://images.unsplash.com/photo-1573408301185-9146fe634ad0?w=400&q=75'),
		array('name' => 'Gold Bar 100g', 'price' => 'AED 28,000', 'icon' => 'fa-cube', 'category' => 'Investment', 'image' => 'https://images.unsplash.com/photo-1610694955371-d4a3e0ce4b52?w=400&q=75'),
	),
	'features' => array(
		array('title' => 'Live Gold Rate', 'icon' => 'fa-line-chart', 'desc' => 'Real-time gold/silver/platinum rates with auto-pricing'),
		array('title' => 'Tag & Barcode', 'icon' => 'fa-barcode', 'desc' => 'Per-piece barcode with weight, karat, and making charges'),
		array('title' => 'Fix/Unfix Trading', 'icon' => 'fa-lock', 'desc' => 'Track fixed vs unfixed gold with settlement reports'),
		array('title' => 'Hallmark Compliance', 'icon' => 'fa-certificate', 'desc' => 'Country-specific hallmarking requirements'),
		array('title' => 'Gold Scheme', 'icon' => 'fa-calendar', 'desc' => 'Monthly installment schemes with maturity tracking'),
		array('title' => 'Tourist Refund', 'icon' => 'fa-plane', 'desc' => 'VAT refund invoices with barcode for tourists'),
	),
	'stats' => array(
		array('value' => 'AED 2B+', 'label' => 'Monthly Volume'),
		array('value' => '99.99%', 'label' => 'Purity Tracking'),
		array('value' => 'DMCC', 'label' => 'Certified'),
		array('value' => '24/7', 'label' => 'Rate Updates'),
	),
	'sub_industries' => array(
		...
		'Jewellery repair & polishing',
		'Jewellery wholesale / B2B',
...
'sub_industry_products' => array(
		...
		'Gold buying & selling' => array('photo'=>'https://images.unsplash.com/photo-1573408301185-9146fe634ad0?w=400&q=75','desc'=>'Gold buying & selling operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with jewellery industry standards and best practices','categories'=>array('Gold Items','Diamond Pieces','Silver Collection','Custom Orders','Repairs','Certification'),'products'=>array(
		...
		'Watches & timepieces' => array('photo'=>'https://images.unsplash.com/photo-1602173574767-37ac01994b2a?w=400&q=75','desc'=>'Watches & timepieces operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with jewellery industry standards and best practices','categories'=>array('Gold Items','Diamond Pieces','Silver Collection','Custom Orders','Repairs','Certification'),'products'=>array(
		...
		'Jewellery wholesale / B2B' => array('photo'=>'https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?w=400&q=75','desc'=>'Jewellery wholesale / B2B operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with jewellery industry standards and best practices','categories'=>array('Bulk Orders','Distribution','B2B Pricing','Clearance Stock','Container Loads','Trade Accounts'),'products'=>array(
		...
		'Luxury auctions' => array('photo'=>'https://images.unsplash.com/photo-1588444837495-c6cfeb53f32d?w=400&q=75','desc'=>'Luxury auctions operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with jewellery industry standards and best practices','categories'=>array('Gold Items','Diamond Pieces','Silver Collection','Custom Orders','Repairs','Certification'),'products'=>array(
		...
		'Antique jewellery' => array('photo'=>'https://images.unsplash.com/photo-1610375461246-83df859d849d?w=400&q=75','desc'=>'Antique jewellery operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with jewellery industry standards and best practices','categories'=>array('Gold Items','Diamond Pieces','Silver Collection','Custom Orders','Repairs','Certification'),'products'=>array(
		...
		'Gem certification & hallmarking' => array('photo'=>'https://images.unsplash.com/photo-1612817159949-195b6eb9e31a?w=400&q=75','desc'=>'Gem certification & hallmarking operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with jewellery industry standards and best practices','categories'=>array('Gold Items','Diamond Pieces','Silver Collection','Custom Orders','Repairs','Certification'),'products'=>array(
		...
		'Silverware & tableware' => array('photo'=>'https://images.unsplash.com/photo-1515562141589-67f0d6ce2609?w=400&q=75','desc'=>'Silverware & tableware operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with jewellery industry standards and best practices','categories'=>array('Gold Items','Diamond Pieces','Silver Collection','Custom Orders','Repairs','Certification'),'products'=>array(
		...
		'Lab-grown diamonds' => array('photo'=>'https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=400&q=75','desc'=>'Lab-grown diamonds operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with jewellery industry standards and best practices','categories'=>array('Sample Collection','Analysis & Testing','Reports','Equipment Calibration','Quality Control','Research'),'products'=>array(
		...
		'Gold loan & pawnbroking' => array('photo'=>'https://images.unsplash.com/photo-1602751584552-8ba73aad10e1?w=400&q=75','desc'=>'Gold loan & pawnbroking operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with jewellery industry standards and best practices','categories'=>array('Gold Items','Diamond Pieces','Silver Collection','Custom Orders','Repairs','Certification'),'products'=>array(
		...
		'Trophy & medal making' => array('photo'=>'https://images.unsplash.com/photo-1617038220319-276d3cfab638?w=400&q=75','desc'=>'Trophy & medal making operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with jewellery industry standards and best practices','categories'=>array('Gold Items','Diamond Pieces','Silver Collection','Custom Orders','Repairs','Certification'),'products'=>array(
		...
		'Jewellery exhibition & trade show' => array('photo'=>'https://images.unsplash.com/photo-1515562141589-67f0d6ce2609?w=400&q=75','desc'=>'Jewellery exhibition & trade show operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with jewellery industry standards and best practices','categories'=>array('Bulk Orders','Distribution','B2B Pricing','Clearance Stock','Container Loads','Trade Accounts'),'products'=>array(
		...
		'Precious metals refining' => array('photo'=>'https://images.unsplash.com/photo-1602751584552-8ba73aad10e1?w=400&q=75','desc'=>'Precious metals refining operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with jewellery industry standards and best practices','categories'=>array('Gold Items','Diamond Pieces','Silver Collection','Custom Orders','Repairs','Certification'),'products'=>array(
