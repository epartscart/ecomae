<?php
/**
 * Cleaning & Maintenance — Industry Template
...
$industryData = array(
	...
	'tagline' => 'Job scheduling + team management + client billing',
	...
	'hero_photo' => 'https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=1600&q=80',
	'gallery_photos' => array(
		...
		'https://images.unsplash.com/photo-1585421514284-efb74c2b69ba?w=600&q=75',
		'https://images.unsplash.com/photo-1528740561666-dc2479dc08ab?w=600&q=75',
		'https://images.unsplash.com/photo-1558317374-067fb5f30001?w=600&q=75',
	),
	'demo_key' => 'cleaning_maintenance',
	'product_label' => 'Products & Services',
	'sample_products' => array(
		array('name' => 'Office Cleaning', 'price' => 'AED 25/hr', 'icon' => 'fa-building', 'category' => 'Commercial', 'image' => 'https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=400&q=75'),
		array('name' => 'Villa Deep Clean', 'price' => 'AED 500', 'icon' => 'fa-home', 'category' => 'Residential', 'image' => 'https://images.unsplash.com/photo-1563453392212-326f5e854473?w=400&q=75'),
		array('name' => 'Carpet Shampooing', 'price' => 'AED 15/sqm', 'icon' => 'fa-square', 'category' => 'Specialty', 'image' => 'https://images.unsplash.com/photo-1585421514284-efb74c2b69ba?w=400&q=75'),
		array('name' => 'Pest Control', 'price' => 'AED 350', 'icon' => 'fa-bug', 'category' => 'Pest', 'image' => 'https://images.unsplash.com/photo-1528740561666-dc2479dc08ab?w=400&q=75'),
		array('name' => 'AC Maintenance', 'price' => 'AED 200', 'icon' => 'fa-snowflake-o', 'category' => 'HVAC', 'image' => 'https://images.unsplash.com/photo-1558317374-067fb5f30001?w=400&q=75'),
		array('name' => 'Pool Maintenance', 'price' => 'AED 400/mo', 'icon' => 'fa-tint', 'category' => 'Pool', 'image' => 'https://images.unsplash.com/photo-1527515545081-5db817172677?w=400&q=75'),
	),
	'features' => array(
		array('title' => 'Job Scheduling', 'icon' => 'fa-calendar', 'desc' => 'Drag-drop calendar with team/route optimization'),
		array('title' => 'Mobile App', 'icon' => 'fa-mobile', 'desc' => 'Staff check-in, photos and job completion'),
		array('title' => 'Client Contracts', 'icon' => 'fa-file-text', 'desc' => 'Recurring service contracts with auto-billing'),
		array('title' => 'Quality Inspections', 'icon' => 'fa-check-circle', 'desc' => 'Supervisor inspections with rating system'),
		array('title' => 'Supply Tracking', 'icon' => 'fa-archive', 'desc' => 'Cleaning supplies inventory and reorder'),
		array('title' => 'Client Portal', 'icon' => 'fa-globe', 'desc' => 'Service requests, feedback and invoices'),
	),
	'stats' => array(
		array('value' => '2,500+', 'label' => 'Companies'),
		array('value' => '15K+', 'label' => 'Jobs/Day'),
		array('value' => '4.9★', 'label' => 'Satisfaction'),
		array('value' => '98%', 'label' => 'SLA Compliance'),
	),
...
'sub_industry_products' => array(
		'Commercial cleaning' => array('photo'=>'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=400&q=75','desc'=>'Commercial cleaning operations encompassing job scheduling, staff allocation, quality checklists, supply management, customer contracts. Provides end-to-end digital workflow management aligned with cleaning services industry standards and best practices','categories'=>array('Office Cleaning','Industrial Sites','Post-Construction','Carpet & Upholstery','Window Cleaning','Pressure Washing'),'products'=>array(
		...
		'Residential cleaning' => array('photo'=>'https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=400&q=75','desc'=>'Residential cleaning operations encompassing job scheduling, staff allocation, quality checklists, supply management, customer contracts. Provides end-to-end digital workflow management aligned with cleaning services industry standards and best practices','categories'=>array('Regular Housekeeping','Deep Cleaning','Move-In/Out','Kitchen & Bath','Laundry Service','Organization'),'products'=>array(
		...
		'Job scheduling' => array('photo'=>'https://images.unsplash.com/photo-1556761175-5973dc0f32e7?w=400&q=75','desc'=>'Job scheduling operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with cleaning services industry standards and best practices','categories'=>array('Scheduling Software','Route Planning','Time Tracking','Client Management','Invoicing','Staff Allocation'),'products'=>array(
		...
		'Pest control' => array('photo'=>'https://images.unsplash.com/photo-1553877522-43269d4ea984?w=400&q=75','desc'=>'Pest control operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with cleaning services industry standards and best practices','categories'=>array('Rodent Bait','Insect Traps','Fumigation Gas','Spray Pumps','Bird Deterrents','Monitoring Devices'),'products'=>array(
		...
		'Waste management & recycling' => array('photo'=>'https://images.unsplash.com/photo-1504384308090-c894fdcc538d?w=400&q=75','desc'=>'Waste management & recycling operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with cleaning services industry standards and best practices','categories'=>array('Skip Bins','Compactors','Recycling Sorters','Collection Trucks','Weighbridges','PPE Equipment'),'products'=>array(
		...
		'Window cleaning' => array('photo'=>'https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=400&q=75','desc'=>'Window cleaning operations encompassing job scheduling, staff allocation, quality checklists, supply management, customer contracts. Provides end-to-end digital workflow management aligned with cleaning services industry standards and best practices','categories'=>array('Residential Windows','High-Rise','Conservatories','Solar Panels','Pressure Wash','Frame Cleaning'),'products'=>array(
		...
		'Carpet & upholstery' => array('photo'=>'https://images.unsplash.com/photo-1556761175-b413da4baf72?w=400&q=75','desc'=>'Carpet & upholstery operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with cleaning services industry standards and best practices','categories'=>array('Steam Cleaning','Stain Protection','Rug Cleaning','Sofa Cleaning','Mattress Cleaning','Leather Care'),'products'=>array(
		...
		'Industrial cleaning' => array('photo'=>'https://images.unsplash.com/photo-1497215728101-856f4ea42174?w=400&q=75','desc'=>'Industrial cleaning operations encompassing job scheduling, staff allocation, quality checklists, supply management, customer contracts. Provides end-to-end digital workflow management aligned with cleaning services industry standards and best practices','categories'=>array('Tank Cleaning','High-Pressure Wash','Chemical Cleaning','Confined Spaces','Waste Disposal','Decontamination'),'products'=>array(
		...
		'Sanitization & disinfection' => array('photo'=>'https://images.unsplash.com/photo-1551434678-e076c223a692?w=400&q=75','desc'=>'Sanitization & disinfection operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with cleaning services industry standards and best practices','categories'=>array('Disinfectant Solutions','Fogging Machines','UV Sanitizers','Air Purifiers','Surface Wipes','Testing Kits'),'products'=>array(
		...
		'Laundry & dry cleaning' => array('photo'=>'https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=400&q=75','desc'=>'Laundry & dry cleaning operations encompassing job scheduling, staff allocation, quality checklists, supply management, customer contracts. Provides end-to-end digital workflow management aligned with cleaning services industry standards and best practices','categories'=>array('Washing Machines','Dry Clean Solvents','Pressing Equipment','Garment Bags','Stain Removers','Conveyor Systems'),'products'=>array(
		...
		'Chimney sweeping' => array('photo'=>'https://images.unsplash.com/photo-1563453392212-326f5e854473?w=400&q=75','desc'=>'Chimney sweeping operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with cleaning services industry standards and best practices','categories'=>array('Sweeping Brushes','Inspection Cameras','Dust Vacuums','Flue Liners','Cowls & Caps','Safety Harnesses'),'products'=>array(
		...
		'Mold & asbestos removal' => array('photo'=>'https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=400&q=75','desc'=>'Mold & asbestos removal operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with cleaning services industry standards and best practices','categories'=>array('Testing Kits','Encapsulants','HEPA Vacuums','Protective Suits','Air Scrubbers','Disposal Bags'),'products'=>array(
		...
		'Hazardous waste cleanup' => array('photo'=>'https://images.unsplash.com/photo-1527515637462-cee1395c108c?w=400&q=75','desc'=>'Hazardous waste cleanup operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with cleaning services industry standards and best practices','categories'=>array('Hazardous Products','Hazardous Services','Hazardous Packages','Hazardous Accessories','Hazardous Support','Hazardous Premium'),'products'=>array(
		...
		'Air duct cleaning' => array('photo'=>'https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=400&q=75','desc'=>'Air duct cleaning operations encompassing job scheduling, staff allocation, quality checklists, supply management, customer contracts. Provides end-to-end digital workflow management aligned with cleaning services industry standards and best practices','categories'=>array('Duct Brushes','HEPA Filters','Video Inspection','Sanitizing Sprays','Negative Air Machines','Access Panels'),'products'=>array(
		...
		'Graffiti removal' => array('photo'=>'https://images.unsplash.com/photo-1563453392212-326f5e854473?w=400&q=75','desc'=>'Graffiti removal operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with cleaning services industry standards and best practices','categories'=>array('Graffiti Products','Graffiti Services','Graffiti Packages','Graffiti Accessories','Graffiti Support','Graffiti Premium'),'products'=>array(
		...
		'Post-construction cleaning' => array('photo'=>'https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=400&q=75','desc'=>'Post-construction cleaning operations encompassing job scheduling, staff allocation, quality checklists, supply management, customer contracts. Provides end-to-end digital workflow management aligned with cleaning services industry standards and best practices','categories'=>array('Regular Cleaning','Deep Clean','Specialized Services','Equipment','Supplies','Staff Management'),'products'=>array(
		...
		'Vehicle detailing & valet' => array('photo'=>'https://images.unsplash.com/photo-1527515637462-cee1395c108c?w=400&q=75','desc'=>'Vehicle detailing & valet operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with cleaning services industry standards and best practices','categories'=>array('Vehicle Products','Vehicle Services','Vehicle Packages','Vehicle Accessories','Vehicle Support','Vehicle Premium'),'products'=>array(
