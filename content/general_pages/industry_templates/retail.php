...
$industryData = array(
	...
	'tagline' => 'Omnichannel retail + POS + marketplace',
	...
	'hero_photo' => 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=1600&q=80',
	'gallery_photos' => array(
		'https://images.unsplash.com/photo-1472851294608-062f824d29cc?w=600&q=75',
		...
		'https://images.unsplash.com/photo-1604719312566-8912e9227c6a?w=600&q=75',
		'https://images.unsplash.com/photo-1567401893414-76b7b1e5a7a5?w=600&q=75',
	),
	'demo_key' => 'retail_ecommerce',
	'product_label' => 'Products & Services',
	'sample_products' => array(
		array('name' => 'Smart Watch Pro', 'price' => 'AED 899', 'icon' => 'fa-clock-o', 'category' => 'Electronics', 'image' => 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=400&q=75'),
		array('name' => 'Organic Coffee Beans', 'price' => 'AED 65', 'icon' => 'fa-coffee', 'category' => 'Grocery', 'image' => 'https://images.unsplash.com/photo-1472851294608-062f824d29cc?w=400&q=75'),
		array('name' => 'Scented Candle Set', 'price' => 'AED 120', 'icon' => 'fa-fire', 'category' => 'Home', 'image' => 'https://images.unsplash.com/photo-1555529669-e69e7aa0ba9a?w=400&q=75'),
		array('name' => 'Running Shoes', 'price' => 'AED 450', 'icon' => 'fa-space-shuttle', 'category' => 'Sports', 'image' => 'https://images.unsplash.com/photo-1441984904996-e0b6df687efe?w=400&q=75'),
		array('name' => 'Wireless Speaker', 'price' => 'AED 299', 'icon' => 'fa-volume-up', 'category' => 'Audio', 'image' => 'https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?w=400&q=75'),
		array('name' => 'Gift Hamper', 'price' => 'AED 350', 'icon' => 'fa-gift', 'category' => 'Gifts', 'image' => 'https://images.unsplash.com/photo-1573855619003-97b4799dcd8b?w=400&q=75'),
	),
	'features' => array(
		array('title' => 'Omnichannel POS', 'icon' => 'fa-shopping-cart', 'desc' => 'Unified cart across store, web, and mobile'),
		array('title' => 'Inventory Sync', 'icon' => 'fa-refresh', 'desc' => 'Real-time stock across all locations'),
		array('title' => 'Marketplace', 'icon' => 'fa-globe', 'desc' => 'Multi-vendor marketplace with commission'),
		array('title' => 'Customer Segments', 'icon' => 'fa-users', 'desc' => 'RFM analysis and targeted campaigns'),
		array('title' => 'Returns Portal', 'icon' => 'fa-exchange', 'desc' => 'Self-service returns with label generation'),
		array('title' => 'Analytics Dashboard', 'icon' => 'fa-bar-chart', 'desc' => 'Sales, conversion and basket analysis'),
	),
	'stats' => array(
		array('value' => '25K+', 'label' => 'Stores'),
		array('value' => '$4.2B', 'label' => 'GMV Processed'),
		array('value' => '99.99%', 'label' => 'Uptime'),
		array('value' => '52', 'label' => 'Countries'),
	),
...
'sub_industry_products' => array(
		'Online storefront' => array('photo'=>'https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=400&q=75','desc'=>'Online storefront operations encompassing inventory management, point-of-sale, customer loyalty programs, visual merchandising, e-commerce integration. Provides end-to-end digital workflow management aligned with retail industry standards and best practices','categories'=>array('In-Store Range','Online Exclusive','Seasonal Offers','Gift Cards','Loyalty Rewards','Click & Collect'),'products'=>array(
		...
		'Point of sale' => array('photo'=>'https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=400&q=75','desc'=>'Point of sale operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with retail industry standards and best practices','categories'=>array('In-Store Range','Online Exclusive','Seasonal Offers','Gift Cards','Loyalty Rewards','Click & Collect'),'products'=>array(
		...
		'Inventory management' => array('photo'=>'https://images.unsplash.com/photo-1472851294608-062f824d29cc?w=400&q=75','desc'=>'Inventory management operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with retail industry standards and best practices','categories'=>array('Planning & Strategy','Operations','Reporting & Analytics','Compliance','Optimization','Staff Coordination'),'products'=>array(
		...
		'Supermarket / grocery' => array('photo'=>'https://images.unsplash.com/photo-1556742111-a301076d9d18?w=400&q=75','desc'=>'Supermarket / grocery operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with retail industry standards and best practices','categories'=>array('In-Store Range','Online Exclusive','Seasonal Offers','Gift Cards','Loyalty Rewards','Click & Collect'),'products'=>array(
		...
		'Marketplace / multi-vendor' => array('photo'=>'https://images.unsplash.com/photo-1534452203293-494d7ddbf7e0?w=400&q=75','desc'=>'Marketplace / multi-vendor operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with retail industry standards and best practices','categories'=>array('In-Store Range','Online Exclusive','Seasonal Offers','Gift Cards','Loyalty Rewards','Click & Collect'),'products'=>array(
		...
		'Wholesale club' => array('photo'=>'https://images.unsplash.com/photo-1560472355-536de3962603?w=400&q=75','desc'=>'Wholesale club operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with retail industry standards and best practices','categories'=>array('Bulk Orders','Distribution','B2B Pricing','Clearance Stock','Container Loads','Trade Accounts'),'products'=>array(
		...
		'Discount / outlet' => array('photo'=>'https://images.unsplash.com/photo-1549488344-1f9b8d2bd1f3?w=400&q=75','desc'=>'Discount / outlet operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with retail industry standards and best practices','categories'=>array('In-Store Range','Online Exclusive','Seasonal Offers','Gift Cards','Loyalty Rewards','Click & Collect'),'products'=>array(
		...
		'Subscription box' => array('photo'=>'https://images.unsplash.com/photo-1557821552-17105176677c?w=400&q=75','desc'=>'Subscription box operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with retail industry standards and best practices','categories'=>array('In-Store Range','Online Exclusive','Seasonal Offers','Gift Cards','Loyalty Rewards','Click & Collect'),'products'=>array(
		...
		'Home decor & furnishing' => array('photo'=>'https://images.unsplash.com/photo-1472851294608-062f824d29cc?w=400&q=75','desc'=>'Home decor & furnishing operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with retail industry standards and best practices','categories'=>array('In-Store Range','Online Exclusive','Seasonal Offers','Gift Cards','Loyalty Rewards','Click & Collect'),'products'=>array(
		...
		'Pharmacy & health store' => array('photo'=>'https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=400&q=75','desc'=>'Pharmacy & health store operations encompassing inventory management, point-of-sale, customer loyalty programs, visual merchandising, e-commerce integration. Provides end-to-end digital workflow management aligned with retail industry standards and best practices','categories'=>array('Prescription Drugs','OTC Medicines','Health Supplements','Medical Devices','Compounding','Delivery'),'products'=>array(
		...
		'Vending machines & kiosks' => array('photo'=>'https://images.unsplash.com/photo-1472851294608-062f824d29cc?w=400&q=75','desc'=>'Vending machines & kiosks operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with retail industry standards and best practices','categories'=>array('In-Store Range','Online Exclusive','Seasonal Offers','Gift Cards','Loyalty Rewards','Click & Collect'),'products'=>array(
