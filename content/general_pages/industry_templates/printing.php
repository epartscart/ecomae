...
$industryData = array(
	...
	'hero_photo' => 'https://images.unsplash.com/photo-1562654501-a0ccc0fc3fb1?w=1600&q=80',
	'gallery_photos' => array(
		'https://images.unsplash.com/photo-1562654501-a0ccc0fc3fb1?w=600&q=75',
		'https://images.unsplash.com/photo-1588412079929-790b9f593d8e?w=600&q=75',
		'https://images.unsplash.com/photo-1598301257982-0cf014dabbcd?w=600&q=75',
		'https://images.unsplash.com/photo-1621609764095-b32bbe35cf3a?w=600&q=75',
		'https://images.unsplash.com/photo-1611532736597-de2d4265fba3?w=600&q=75',
	),
	'demo_key' => 'printing_signage',
	'product_label' => 'Products & Services',
	'sample_products' => array(
		array('name' => 'Business Cards (500)', 'price' => 'AED 120', 'icon' => 'fa-id-card', 'category' => 'Print', 'image' => 'https://images.unsplash.com/photo-1562654501-a0ccc0fc3fb1?w=400&q=75'),
		array('name' => 'Banner (3x6m)', 'price' => 'AED 350', 'icon' => 'fa-flag', 'category' => 'Large Format', 'image' => 'https://images.unsplash.com/photo-1588412079929-790b9f593d8e?w=400&q=75'),
		array('name' => 'Brochure (1000)', 'price' => 'AED 800', 'icon' => 'fa-book', 'category' => 'Marketing', 'image' => 'https://images.unsplash.com/photo-1598301257982-0cf014dabbcd?w=400&q=75'),
		array('name' => 'Vehicle Wrap', 'price' => 'AED 3,500', 'icon' => 'fa-car', 'category' => 'Signage', 'image' => 'https://images.unsplash.com/photo-1621609764095-b32bbe35cf3a?w=400&q=75'),
		array('name' => 'T-Shirt Print (50)', 'price' => 'AED 750', 'icon' => 'fa-male', 'category' => 'Apparel', 'image' => 'https://images.unsplash.com/photo-1611532736597-de2d4265fba3?w=400&q=75'),
		array('name' => 'Packaging Design', 'price' => 'AED 2,000', 'icon' => 'fa-archive', 'category' => 'Design', 'image' => 'https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=400&q=75'),
	),
	'features' => array(
...
'sub_industry_products' => array(
		...
		'Packaging & labels' => array('photo'=>'https://images.unsplash.com/photo-1556761175-5973dc0f32e7?w=400&q=75','desc'=>'Packaging & labels operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with printing industry standards and best practices','categories'=>array('Sample Collection','Analysis & Testing','Reports','Equipment Calibration','Quality Control','Research'),'products'=>array(
		...
		'Screen printing & embroidery' => array('photo'=>'https://images.unsplash.com/photo-1504384308090-c894fdcc538d?w=400&q=75','desc'=>'Screen printing & embroidery operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with printing industry standards and best practices','categories'=>array('Digital Printing','Offset Printing','Large Format','Finishing','Design Services','Delivery'),'products'=>array(
		...
		'Banner & display' => array('photo'=>'https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=400&q=75','desc'=>'Banner & display operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with printing industry standards and best practices','categories'=>array('Digital Printing','Offset Printing','Large Format','Finishing','Design','Delivery'),'products'=>array(
		...
		'Bookbinding & finishing' => array('photo'=>'https://images.unsplash.com/photo-1497215728101-856f4ea42174?w=400&q=75','desc'=>'Bookbinding & finishing operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with printing industry standards and best practices','categories'=>array('Digital Printing','Offset Printing','Large Format','Finishing','Design','Delivery'),'products'=>array(
		...
		'Offset printing' => array('photo'=>'https://images.unsplash.com/photo-1551434678-e076c223a692?w=400&q=75','desc'=>'Offset printing operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with printing industry standards and best practices','categories'=>array('Digital Printing','Offset Printing','Large Format','Finishing','Design Services','Delivery'),'products'=>array(
		...
		'Gift & personalized items' => array('photo'=>'https://images.unsplash.com/photo-1556761175-4b46a572b786?w=400&q=75','desc'=>'Gift & personalized items operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with printing industry standards and best practices','categories'=>array('Digital Printing','Offset Printing','Large Format','Finishing','Design','Delivery'),'products'=>array(
		...
		'3D printing services' => array('photo'=>'https://images.unsplash.com/photo-1562654501-a0ccc0fc3fb1?w=400&q=75','desc'=>'3D printing services operations encompassing job scheduling, technician dispatch, parts inventory, service history, warranty tracking. Provides end-to-end digital workflow management aligned with printing industry standards and best practices','categories'=>array('Digital Printing','Offset Printing','Large Format','Finishing','Design Services','Delivery'),'products'=>array(
		...
		'Textile printing & sublimation' => array('photo'=>'https://images.unsplash.com/photo-1588666309990-d68f08e3d4a6?w=400&q=75','desc'=>'Textile printing & sublimation operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with printing industry standards and best practices','categories'=>array('Digital Printing','Offset Printing','Large Format','Finishing','Design Services','Delivery'),'products'=>array(
		...
		'Photo printing & lab' => array('photo'=>'https://images.unsplash.com/photo-1614849963640-9cc74b2a826f?w=400&q=75','desc'=>'Photo printing & lab operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with printing industry standards and best practices','categories'=>array('Sample Collection','Analysis & Testing','Reports','Equipment Calibration','Quality Control','Research'),'products'=>array(
		...
		'Engraving & laser etching' => array('photo'=>'https://images.unsplash.com/photo-1561070791-2526d30994b5?w=400&q=75','desc'=>'Engraving & laser etching operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with printing industry standards and best practices','categories'=>array('Digital Printing','Offset Printing','Large Format','Finishing','Design','Delivery'),'products'=>array(
		...
		'Stamp & seal making' => array('photo'=>'https://images.unsplash.com/photo-1562654501-a0ccc0fc3fb1?w=400&q=75','desc'=>'Stamp & seal making operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with printing industry standards and best practices','categories'=>array('Digital Printing','Offset Printing','Large Format','Finishing','Design','Delivery'),'products'=>array(
		...
		'Business card & stationery' => array('photo'=>'https://images.unsplash.com/photo-1614849963640-9cc74b2a826f?w=400&q=75','desc'=>'Business card & stationery operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with printing industry standards and best practices','categories'=>array('Digital Printing','Offset Printing','Large Format','Finishing','Design','Delivery'),'products'=>array(
		...
		'Security printing (certificates)' => array('photo'=>'https://images.unsplash.com/photo-1588666309990-d68f08e3d4a6?w=400&q=75','desc'=>'Security printing (certificates) operations encompassing patrol scheduling, incident reporting, access control, alarm monitoring, staff deployment. Provides end-to-end digital workflow management aligned with printing industry standards and best practices','categories'=>array('Certificate Printing','Hologram Labels','Watermark Paper','Tamper-Proof Seals','ID Cards','Document Security'),'products'=>array(
		...
		'Label & barcode printing' => array('photo'=>'https://images.unsplash.com/photo-1614849963640-9cc74b2a826f?w=400&q=75','desc'=>'Label & barcode printing operations encompassing operations management, client relationship management, resource planning, quality assurance, financial tracking. Provides end-to-end digital workflow management aligned with printing industry standards and best practices','categories'=>array('Sample Collection','Analysis & Testing','Reports','Equipment Calibration','Quality Control','Research'),'products'=>array(
