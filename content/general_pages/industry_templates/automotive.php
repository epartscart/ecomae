...
$industryData = array(
	...
	'features' => array(
		array('title' => 'Parts Cross-Reference', 'icon' => 'fa-exchange', 'desc' => 'OE and aftermarket cross-references with live stock'),
    ...
    'about_text' => 'The automotive industry spans vehicle manufacturing, parts distribution, dealership networks, aftermarket services, and fleet management. With over 80 million vehicles produced annually worldwide, this sector demands sophisticated inventory management, parts cross-referencing, warranty tracking, and multi-location parts logistics. Our platform supports everything from independent workshops to multi-brand dealer groups with tailored ERP processes.',
    'about_highlights' => array(
        'OE and aftermarket parts cross-reference with VIN-based fitment',
...
'sub_industry_products' => array(
		'Parts catalog & cross-references' => array('photo'=>'https://images.unsplash.com/photo-1552519507-da3b142c6e3d?w=400&q=75','desc'=>'OEM and aftermarket parts lookup with cross-reference databases. Covers engine, transmission, brakes, electrical, and body panels with VIN-based fitment verification','categories'=>array('Parts Solutions','Core Services','Premium Tier','Add-On Modules','Analytics','Support & Training'),'products'=>array(
