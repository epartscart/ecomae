...
function epc_portal_default_theme_template_by_industry()
{
	return array(
		'auto_parts' => 'classic',
		'automotive_full_vehicles' => 'classic',
		'tax_advisory' => 'modern',
		'electronics' => 'midnight',
		'it_hardware_accessories' => 'midnight',
		'fashion' => 'signature',
		'jewellery' => 'classic',
		'medical' => 'modern',
		'pharmacy_retail' => 'modern',
		'nutrition_supplements' => 'signature',
		'food_beverage' => 'classic',
		'grocery_retail' => 'classic',
		'furniture_interiors' => 'modern',
		'building_materials' => 'classic',
		'fmcg_wholesale' => 'classic',
		'industrial_equipment' => 'midnight',
		'agricultural_products' => 'signature',
		'perfume_cosmetics' => 'signature',
		'pet_services' => 'classic',
		'health' => 'signature',
		'beauty_skincare' => 'signature',
		'fitness_training' => 'classic',
		'hospitality_travel' => 'modern',
		'clinics_telemedicine' => 'modern',
		'consultancy' => 'modern',
		'legal_services' => 'midnight',
		'accounting_auditing' => 'modern',
		'hr_recruitment' => 'modern',
		'marketing_digital' => 'signature',
		'education_training' => 'modern',
		'cleaning_facilities' => 'classic',
		'security_services' => 'midnight',
		'printing_signage' => 'classic',
		'construction_contracting' => 'classic',
		'logistics_freight' => 'midnight',
		'financial_services' => 'modern',
		'rental' => 'classic',
		'vehicle_leasing' => 'classic',
		'machinery_rental' => 'classic',
		'it_services_saas_support' => 'midnight',
		'media_entertainment' => 'signature',
		'energy_utilities' => 'classic',
		'manufacturing_industrial' => 'midnight',
		'erp_standalone' => 'classic',
		'nonprofit_government' => 'midnight',
