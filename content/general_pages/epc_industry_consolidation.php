...
function epc_industry_resolve_group(string $industryName, string $badgeCategory = ''): string
{
    ...
    $rules = array(
        ...
        'electronics_technology' => array('electronic', 'computer', 'laptop', 'mobile phone', 'gadget', 'gaming', 'audio', 'tv ', 'television', 'appliance', 'typewriter', 'semiconductor', 'circuit'),
        'construction_realestate' => array('construction', 'real estate', 'property', 'architect', 'interior design', 'plumb', 'electrical contract', 'painting', 'landscap', 'demolition', 'survey', 'steel fabricat', 'concrete', 'waterproof', 'insulation', 'flooring', 'roofing', 'tunnel', 'pipeline', 'road ', 'bridge', 'contracting', 'building', 'civil engineer', 'hvac', 'fit-out', 'marine construct'),
        'manufacturing_industrial' => array('manufactur', 'factory', 'production', 'assembly', 'chemical', 'plastic', 'rubber', 'metal', 'steel ', 'glass ', 'ceramic', 'pottery', 'paper', 'pulp', '3d print', 'woodwork', 'carpentry', 'foundry', 'extrusion', 'welding', 'fabricat', 'adhesive', 'varnish', 'aluminum', 'wire ', 'valve', 'casting', 'machinery', 'equipment mfg', 'aircraft', 'handicraft', 'mill'),
        'professional_services' => array('consulting', 'consultancy', 'law firm', 'legal', 'accounting firm', 'audit firm', 'tax ', 'bookkeep', 'hr ', 'recruitment', 'staffing', 'marketing agency', 'advertising agency', 'pr agency', 'translation', 'research', 'advisor', 'notary', 'trademark', 'patent', 'classification', 'certification', 'inspection', 'testing lab', 'quality'),
        ...
        'financial_services' => array('bank', 'insurance', 'fintech', 'wealth', 'investment', 'venture capital', 'lending', 'forex', 'payment', 'crypto', 'asset management', 'collection agency', 'financial intermediat', 'exchange', 'money transfer', 'islamic finance', 'reinsurance'),
