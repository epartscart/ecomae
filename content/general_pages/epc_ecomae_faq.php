...
.epm-faq-search input{width:100%;padding:14px 48px 14px 18px;border-radius:12px;border:1px solid rgba(56,189,248,.35);background:rgba(2,6,23,.75);color:#e2e8f0;font-size:16px}
.epm-faq-search input:focus{outline:none;border-color:#38bdf8;box-shadow:0 0 0 3px rgba(56,189,248,.2)}
...
.epm-faq-stat{font-size:13px;padding:6px 12px;border-radius:999px;background:rgba(15,23,42,.8);border:1px solid rgba(148,163,184,.2);color:#94a3b8}
...
.epm-faq-tab{padding:10px 16px;border-radius:10px;border:1px solid rgba(56,189,248,.25);background:rgba(2,6,23,.5);color:#94a3b8;font-size:13px;cursor:pointer;transition:.15s}
.epm-faq-tab:hover,.epm-faq-tab.is-active{background:linear-gradient(135deg,#0c4a6e,#0369a1);color:#fff;border-color:transparent}
...
.epm-faq-item{border:1px solid rgba(148,163,184,.15);border-radius:12px;margin-bottom:10px;background:rgba(15,23,42,.55);overflow:hidden}
...
.epm-faq-item__q:hover{background:rgba(56,189,248,.06)}
...
.epm-faq-item__a a{color:#38bdf8;text-decoration:underline}
...
.epm-faq__status--planned{background:rgba(56,189,248,.12);color:#38bdf8}
