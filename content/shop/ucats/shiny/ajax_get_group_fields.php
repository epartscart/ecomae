...
$curl = curl_init();
curl_setopt($curl, CURLOPT_URL, $DP_Config->ucats_url."ucats/shiny/get_group_fields.php?login=".$DP_Config->ucats_login."&password=".$DP_Config->ucats_password."&group=".urlencode($group));
