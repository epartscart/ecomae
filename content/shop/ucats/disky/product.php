...
$curl = curl_init();
curl_setopt($curl, CURLOPT_URL, $DP_Config->ucats_url."ucats/disky/get_product.php?login=".$DP_Config->ucats_login."&password=".$DP_Config->ucats_password."&product_id=$product_id&group=".$group);
