...
function epc_reg_render_account_tabs(): void
{
	...
	<div class="panel panel-primary epc-reg-account-panel">
		...
		<div class="panel-body">
			<p class="help-block" style="margin-top:0;">Fields marked <strong>*</strong> are mandatory. <strong>Retail customer</strong> — approved immediately; browse and checkout (default currency AED where configured). <strong>Wholesale customer</strong> — pending until a manager approves trade pricing and currency in the Control Panel.</p>
