...
// Landing / catalogs → AJAX UI with two sections (VIN + brands).
if (!$forceGuayaquil && ($task === '' || $task === 'catalogs')) {
	$langPrefix = '';
	...
	?>
	<link rel="stylesheet" href="/api/Laximo/laximo.css?v=20260717lax1" type="text/css" />
	...
	<script src="/api/Laximo/laximo.js?v=20260717lax1"></script>
	<script>
		jQuery(function () {
