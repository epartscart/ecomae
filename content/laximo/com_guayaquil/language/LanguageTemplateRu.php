...
abstract class LanguageTemplateRu extends LanguageTemplate
{
    ...
    public static $language_data = array(
        ...
        'welcomeLinkOem'                     => 'Начать просмотр OEM-каталога',
        'welcomeLinkAm'                      => 'Начать просмотр aftermarket-каталога',
        'welcomeLinkAuto3nAM'                => 'Начать просмотр aftermarket-каталога',
        ...
        'GET_LOGIN'                          => 'Введите логин и ключ каталога',
        'GET_LOGIN_AM'                       => 'Введите логин и ключ aftermarket-каталога',
