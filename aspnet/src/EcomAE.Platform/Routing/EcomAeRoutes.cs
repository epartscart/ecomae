...
public static class EcomAeRoutes
{
    ...
    public const string LegacyLogout = "/auth/logout";
    ...
    public const string ControlPanelLogout = "/cp/logout";
    ...
    /// <summary>Crosses CSV export; twin of PHP crosses/download_crosses.php.</summary>
    public const string CpCrossesDownloadCsv = "/cp/crosses/download.csv";
    ...
    /// <summary>CP auto-price add_discovery_source / toggle_discovery_source / skip_source / delete_discovery_source. <c>confirmWrites=true</c> twins PHP ajax_auto_price.php. Compare-run stays Classic.</summary>
    ...
    /// <summary>CRM opportunity update_stage and save_opportunity. <c>confirmWrites=true</c> twins PHP ajax_crm.php. Convert / quote email stay Classic.</summary>
    ...
    /// <summary>CRM save_contract. <c>confirmWrites=true</c> twins PHP ajax_crm.php. Quote email stays Classic.</summary>
    public const string CpCrmContractsWrite = "/cp/crm/contracts/write";
    /// <summary>CRM save_expense. <c>confirmWrites=true</c> twins PHP ajax_crm.php. Approve-to-cash stays Classic.</summary>
    public const string CpCrmExpensesWrite = "/cp/crm/expenses/write";
    ...
    /// <summary>CRM toggle_activity / save_activity. <c>confirmWrites=true</c> twins PHP ajax_crm.php. Quote email and send stay Classic.</summary>
    ...
    /// <summary>CP + Super CP operator guide hub (PHP guideline / upload / OMS / portal books).</summary>
    public const string ControlPanelGuidesApp = "/cp/guides-app";
    ...
    /// <summary>ERP legal entities / company picker digest (PHP <c>epc_erp_companies_list</c>).</summary>
    public const string ErpCompanies = "/erp/companies";
    ...
    /// <summary>Live PHP epc_coll_hold_set twin (confirmWrites=true). Schema ensure stays PHP.</summary>
    public const string ErpCollectionsHoldSet = "/erp/collections/hold/set";
    /// <summary>Live PHP epc_coll_dunning_run twin (confirmWrites=true). Schema ensure stays PHP.</summary>
    public const string ErpCollectionsDunningRun = "/erp/collections/dunning/run";
    ...
    /// <summary>Live PHP epc_wht_certificate_issue twin.</summary>
    public const string ErpWithholdingTxnsCertificate = "/erp/withholding/txns/certificate";
    ...
    /// <summary>PHP epc_hr_attendance_log. <c>confirmWrites=true</c> writes via <c>IErpHrAttendanceWriteService</c>.</summary>
    public const string ErpHrAttendanceLog = "/erp/hr/attendance/log";
    /// <summary>Live PHP hr_attendance twin (ajax alias of <see cref="ErpHrAttendanceLog"/>).</summary>
    ...
    /// <summary>PHP epc_hr_expense_save. <c>confirmWrites=true</c> writes via <c>IErpHrExpenseSaveWriteService</c>.</summary>
    ...
    /// <summary>PHP <c>vendor_code_save</c> / <c>epc_multivendor_vendor_code_save</c>. <c>confirmWrites=true</c> UPDATEs shop_storages name/short_name. File ingest stay Classic.</summary>
    ...
    /// <summary>PHP ajax_epc_quote_alt_options.php: cross/OEM alternatives + supplier warehouses for a quote line (JSON, staff read).</summary>
    public const string CpQuoteAltOptions = "/cp/quote-requests/alt-options";
    ...
    /// <summary>Live PHP epc_wht_certificate_issue twin (ajax alias of <see cref="ErpWithholdingTxnsCertificate"/>).</summary>
    ...
    /// <summary>HTML form POST for PHP <c>uae_tax_fta_fetch</c>. <c>confirmWrites=true</c> writes via <c>IErpUaeTaxFtaFetchWriteService</c>.</summary>
    public const string ErpUaeTaxFtaFetch = "/erp/uae-tax/fta-fetch";
    /// <summary>Live PHP <c>epc_uae_fta_fetch_legislation_updates</c> ajax alias of <see cref="ErpUaeTaxFtaFetch"/>.</summary>
    ...
    /// <summary>Live PHP epc_coll_dunning_run twin (ajax alias of <see cref="ErpCollectionsDunningRun"/>).</summary>
    ...
    /// <summary>Live PHP ajax_epc_bos.php notifications prefs_save. confirmWrites=true UPSERTs epc_notification_prefs. Super-CP only.</summary>
    public const string BosNotificationsPrefsSave = "/bos/notifications/prefs-save";
    /// <summary>Live PHP ajax_epc_bos.php notifications cleanup. confirmWrites=true DELETEs old read epc_notifications. Super-CP only.</summary>
    public const string BosNotificationsCleanup = "/bos/notifications/cleanup";
    /// <summary>Live PHP ajax_epc_bos.php credit_limit hold. confirmWrites=true UPDATEs epc_credit_limits. Super-CP only.</summary>
    ...
    public const string BosFulfillmentTransition = "/bos/fulfillment/transition";
    ...
    /// <summary>Live PHP ajax_epc_bos.php subscription_billing subscribe. confirmWrites=true INSERTs epc_subscriptions. Super-CP only.</summary>
    public const string BosBillingSubscribe = "/bos/billing/subscribe";
    ...
    /// <summary>Live PHP ajax_epc_bos.php warranty_rma rma_transition. confirmWrites=true UPDATEs epc_rma_requests. Super-CP only.</summary>
    public const string BosRmaTransition = "/bos/rma/transition";
    /// <summary>Live PHP ajax_epc_bos.php warranty_rma register. confirmWrites=true INSERTs epc_warranties. Super-CP only.</summary>
    public const string BosRmaRegister = "/bos/rma/register";
    /// <summary>Live PHP ajax_epc_bos.php dealer_portal auto_tier. confirmWrites=true UPDATEs epc_dealers. Super-CP only.</summary>
    ...
    public const string BosMarketplaceInstall = "/bos/marketplace/install";
    /// <summary>Live PHP ajax_epc_bos.php marketplace review. confirmWrites=true INSERTs epc_marketplace_reviews. Super-CP only.</summary>
    public const string BosMarketplaceReview = "/bos/marketplace/review";
    /// <summary>Live PHP ajax_epc_bos.php industry_packs assign. confirmWrites=true UPSERTs epc_tenant_pack_assignments. Super-CP only.</summary>
    ...
    /// <summary>Live PHP ajax_epc_bos.php document_vault upload. confirmWrites=true INSERTs epc_vault_documents + epc_vault_versions. Super-CP only.</summary>
    public const string BosVaultUpload = "/bos/vault/upload";
    ...
    /// <summary>Live PHP ajax_epc_bos.php nl_reporting create. confirmWrites=true INSERTs epc_report_definitions. Super-CP only.</summary>
    ...
    /// <summary>LifeOS Master Spec UI (Parts 1–10). Prefer this over <see cref="LifeOsSpecApp"/>.</summary>
    public const string LifeOsSpec = "/lifeos/spec";
    /// <summary>JSON digest for Master Spec Parts 1–10 (was historically at /lifeos/spec).</summary>
    public const string LifeOsSpecJson = "/lifeos/spec/json";
    ...
    public const string LifeOsClientsApp = "/lifeos/clients-app";
    public const string LifeOsDesignSystem = "/lifeos/design-system";
    public const string LifeOsWorkspaceUx = "/lifeos/workspace-ux";
    public const string LifeOsModalityClients = "/lifeos/modality-clients";
    public const string LifeOsContinuity = "/lifeos/continuity";
    ...
    /// <summary>PHP epc_cons_ic_save. <c>confirmWrites=true</c> writes via <c>IErpConsIcSaveWriteService</c>.</summary>
    public const string ErpConsolidationsIcSave = "/erp/consolidations/ic/save";
    /// <summary>PHP epc_ins_save. <c>confirmWrites=true</c> writes via <c>IErpInsSaveWriteService</c>.</summary>
    public const string ErpInsuranceSave = "/erp/insurance/save";
    /// <summary>PHP epc_ins_doc_add. <c>confirmWrites=true</c> writes via <c>IErpInsDocAddWriteService</c>.</summary>
    public const string ErpInsuranceDocsAdd = "/erp/insurance/docs/add";
    ...
    /// <summary>Live PHP epc_mfg_wo_create twin. confirmWrites=true writes via IErpMfgWoCreateWriteService.</summary>
    public const string ErpManufacturingWoCreate = "/erp/manufacturing/work-orders/create";
    ...
    public const string ErpComplianceRetentionSave = "/erp/compliance/retention/save";
    ...
    /// <summary>Live PHP epc_bos_wf_raise / bos_wf_raise_test twin (confirmWrites=true writes).</summary>
    public const string ErpApprovalsRequestRaise = "/erp/approvals/requests/raise";
    /// <summary>Live PHP epc_oa_party_save twin (ajax alias of <see cref="ErpContactsPartiesSave"/>).</summary>
    public const string ErpContactsPartiesSave = "/erp/contacts/parties/save";
    ...
    /// <summary>Live PHP epc_er_field_add twin (ajax alias of <see cref="ErpElectronicReportingFieldsAdd"/>).</summary>
    public const string ErpElectronicReportingFieldsAdd = "/erp/electronic-reporting/fields/add";
    /// <summary>Live PHP epc_rtl_channel_save twin (ajax alias of <see cref="ErpRetailChannelsSave"/>).</summary>
    public const string ErpRetailChannelsSave = "/erp/retail/channels/save";
    /// <summary>Live PHP epc_oa_contact_save twin (ajax alias of <see cref="ErpContactsPartyContactsSave"/>).</summary>
    public const string ErpContactsPartyContactsSave = "/erp/contacts/party-contacts/save";
    /// <summary>Live PHP epc_oa_holiday_add twin (ajax alias of <see cref="ErpOrgHolidaysAdd"/>).</summary>
    public const string ErpOrgHolidaysAdd = "/erp/org/holidays/add";
    ...
    /// <summary>Live PHP epc_plt_feature_save twin (ajax alias of <see cref="ErpPlatformFeaturesSave"/>).</summary>
    public const string ErpPlatformFeaturesSave = "/erp/platform/features/save";
    ...
    /// <summary>Live PHP epc_pf_process_save twin (ajax alias of <see cref="ErpProcessFlowProcessesSave"/>).</summary>
    public const string ErpProcessFlowProcessesSave = "/erp/process-flow/processes/save";
    /// <summary>Live PHP epc_erp_kb_save twin (ajax alias of <see cref="ErpGuideArticlesSave"/>).</summary>
    public const string ErpGuideArticlesSave = "/erp/guide/articles/save";
    ...
    /// <summary>Live PHP epc_intg_sub_save twin (ajax alias of <see cref="ErpIntegrationsSubsSave"/>).</summary>
    public const string ErpIntegrationsSubsSave = "/erp/integrations/subscriptions/save";
    /// <summary>Live PHP epc_erp_multi_entity_set twin (ajax alias of <see cref="ErpMultiEntityPreferenceSave"/>).</summary>
    public const string ErpMultiEntityPreferenceSave = "/erp/multi-entity/preference/save";
    /// <summary>Live PHP epc_costm_item_set twin (ajax alias of <see cref="ErpCostModelsItemsSet"/>).</summary>
    public const string ErpCostModelsItemsSet = "/erp/cost-models/items/set";
    ...
    /// <summary>Live PHP epc_plt_batch_run twin (ajax alias of <see cref="ErpPlatformJobsRun"/>).</summary>
    public const string ErpPlatformJobsRun = "/erp/platform/jobs/run";
    ...
    /// <summary>Live PHP epc_rbac_privilege_save twin (ajax alias of <see cref="ErpSecurityPrivilegesSave"/>).</summary>
    public const string ErpSecurityPrivilegesSave = "/erp/security/privileges/save";
    ...
    /// <summary>Live PHP epc_rbac_role_attach_duty twin (ajax alias of <see cref="ErpSecurityRolesAttachDuty"/>).</summary>
    public const string ErpSecurityRolesAttachDuty = "/erp/security/roles/attach-duty";
    ...
    /// <summary>HTML form POST for PHP <c>proc_category_save</c>. <c>confirmWrites=true</c> writes via <c>IErpProcCategorySaveWriteService</c>.</summary>
    public const string ErpProcurementCategorySave = "/erp/procurement/categories/save";
    ...
    /// <summary>HTML form POST for PHP <c>hrt_applicant_add</c>. <c>confirmWrites=true</c> writes via <c>IErpHrtApplicantAddWriteService</c>.</summary>
    public const string ErpRecruitmentApplicantAdd = "/erp/recruitment/applicants/add";
    /// <summary>HTML form POST for PHP <c>bplan_save</c>. <c>confirmWrites=true</c> writes via <c>IErpBplanSaveWriteService</c>.</summary>
    public const string ErpBudgetPlanSave = "/erp/budget-planning/plans/save";
    ...
    /// <summary>HTML form POST for PHP <c>hrt_review_save</c>. <c>confirmWrites=true</c> writes via <c>IErpHrtReviewSaveWriteService</c>.</summary>
    public const string ErpPerformanceReviewSave = "/erp/performance/reviews/save";
    ...
    public const string ErpCashForecastLineAdd = "/erp/cash-forecast/lines/add";
    /// <summary>HTML form POST for PHP <c>cft_instrument_save</c>. <c>confirmWrites=true</c> writes via <c>IErpCftInstrumentSaveWriteService</c>.</summary>
    public const string ErpBankInstrumentSave = "/erp/bank-instruments/save";
    ...
    /// <summary>HTML form POST for PHP <c>docx_save</c>. <c>confirmWrites=true</c> writes via <c>IErpDocxSaveWriteService</c>.</summary>
    ...
    /// <summary>HTML form POST for PHP <c>uae_tax_legislation_checklist_set</c>. <c>confirmWrites=true</c> writes via <c>IErpUaeTaxLegislationChecklistSetWriteService</c>.</summary>
    public const string ErpUaeTaxLegislationChecklistSet = "/erp/uae-tax/legislation/checklist/set";
    /// <summary>HTML form POST for PHP pm_save. confirmWrites=true writes via IErpPmSaveWriteService.</summary>
    public const string ErpPmSave = "/erp/pm/save";
    /// <summary>HTML form POST for PHP pm_budget_save. confirmWrites=true writes via IErpPmBudgetSaveWriteService.</summary>
    public const string ErpPmBudgetSave = "/erp/pm/budgets/save";
    /// <summary>HTML form POST for PHP pm_budget_line_save. confirmWrites=true writes via IErpPmBudgetLineSaveWriteService.</summary>
    public const string ErpPmBudgetLineSave = "/erp/pm/budget-lines/add";
    ...
    /// <summary>HTML form POST for PHP pm_cheque_save. confirmWrites=true writes via IErpPmChequeSaveWriteService.</summary>
    public const string ErpPmChequeSave = "/erp/pm/cheques/save";
    ...
    /// <summary>HTML form POST for PHP mfgr_route_save. confirmWrites=true writes via IErpMfgrRouteSaveWriteService.</summary>
    public const string ErpMfgrRouteSave = "/erp/mfgr/routes/save";
    ...
    /// <summary>HTML form POST for PHP opening_create_batch. confirmWrites=true writes via IErpOpeningCreateBatchWriteService.</summary>
    public const string ErpOpeningCreateBatch = "/erp/opening/create-batch";
