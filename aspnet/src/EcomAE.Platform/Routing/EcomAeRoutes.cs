...
public static class EcomAeRoutes
{
    ...
    /// <summary>CP auto-price toggle_discovery_source / delete_discovery_source. <c>confirmWrites=true</c> twins PHP ajax_auto_price.php. Add and compare-run stay Classic.</summary>
