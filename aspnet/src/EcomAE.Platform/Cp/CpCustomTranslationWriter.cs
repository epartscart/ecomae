...
/// <summary>PHP <c>save_custom_translation()</c> twin: upserts a custom <c>lang_text_strings</c> key plus its per-language value.</summary>
public sealed class CpCustomTranslationWriter
{
    private readonly string _description;
    private int _createdStrings;

    public CpCustomTranslationWriter(string description)
    {
        _description = description;
    }

    public static string NormalizeLang(string? langCode)
    {
        ...
        CancellationToken cancellationToken)
    {
        ...
        throw new ErpWriteException("Could not allocate a translation key.");
    }
}
