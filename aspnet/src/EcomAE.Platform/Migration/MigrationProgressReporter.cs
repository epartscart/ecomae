...
public sealed class MigrationProgressReporter : IMigrationProgressReporter
{
    public MigrationProgressReport BuildReport()
    {
        ...
        [
            ...
            new("Public API compatibility scaffolding", 10, 40, "sql-contract-started", "Replace placeholder price lookup with database-backed catalog services and parity tests."),
