...
public sealed class MigrationProgressReporter : IMigrationProgressReporter
{
    public MigrationProgressReport BuildReport()
    {
        ...
        [
            ...
            new("Production cutover and PHP removal", 5, 20, "route-cutover-policy-started", "Complete parity, route feature flags, rollback validation, telemetry, and then remove PHP files/runtime.")
        ];
