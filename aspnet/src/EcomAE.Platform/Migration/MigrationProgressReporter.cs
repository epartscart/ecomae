...
public sealed class MigrationProgressReporter : IMigrationProgressReporter
{
    public MigrationProgressReport BuildReport()
    {
        ...
        [
            ...
            new("Legacy CP/ERP/BOS session bridge", 7, 85, "api-client-parity-endpoint-started", "Validate PHP session cookie semantics and permission mapping against production login flows."),
