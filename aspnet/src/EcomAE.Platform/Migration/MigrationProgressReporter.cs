...
public sealed class MigrationProgressReporter : IMigrationProgressReporter
{
    public MigrationProgressReport BuildReport()
    {
        ...
        [
            ...
            new("Legacy CP/ERP/BOS session bridge", 7, 57, "api-client-policy-parity", "Validate PHP session cookie semantics and permission mapping against production login flows."),
