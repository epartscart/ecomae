...
public sealed class MigrationProgressReporter : IMigrationProgressReporter
{
    public MigrationProgressReport BuildReport()
    {
        ...
        [
            ...
            new("Platform ERP migration", 18, 32, "erp-parity-visible", "Port finance, inventory, sales, purchase, invoice, reporting, and audit modules."),
            new("Super BOS migration", 8, 40, "bos-parity-visible", "Port command center, privileged operations, and audit trails."),
            new("Tenant CP and tenant ERP migration", 10, 25, "tenant-workspace-parity-visible", "Port tenant-scoped CP/ERP workflows for live and ERP-only tenants."),
            new("Storefront migration", 7, 45, "storefront-parity-visible", "Port storefront rendering, catalog browsing, cart, checkout, and customer account flows."),
            ...
            new("Production cutover and PHP removal", 5, 80, "route-cutover-headers-started", "Complete parity, route feature flags, rollback validation, telemetry, and then remove PHP files/runtime.")
        ];
