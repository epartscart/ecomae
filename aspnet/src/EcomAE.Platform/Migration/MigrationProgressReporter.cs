...
public sealed class MigrationProgressReporter : IMigrationProgressReporter
{
    public MigrationProgressReport BuildReport()
    {
        ...
        [
            ...
            new("Public API compatibility scaffolding", 10, 80, "price-parity-endpoint-started", "Replace placeholder price lookup with database-backed catalog services and parity tests."),
