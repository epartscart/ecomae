...
public sealed class MigrationProgressReporter : IMigrationProgressReporter
{
    public MigrationProgressReport BuildReport()
    {
        ...
        [
            ...
            new("Legacy CP/ERP/BOS session bridge", 7, 28, "api-key-prefix-parity", "Validate PHP session cookie semantics and permission mapping against production login flows."),
