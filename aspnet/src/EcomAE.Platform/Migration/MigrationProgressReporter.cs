...
public sealed class MigrationProgressReporter : IMigrationProgressReporter
{
    public MigrationProgressReport BuildReport()
    {
        ...
        [
            ...
            new("Production cutover and PHP removal", 5, 60, "configurable-route-cutover-started", "Complete parity, route feature flags, rollback validation, telemetry, and then remove PHP files/runtime.")
        ];
