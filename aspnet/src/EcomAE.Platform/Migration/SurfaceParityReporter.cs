...
public sealed class SurfaceParityReporter : ISurfaceParityReporter
{
    public SurfaceParityReport BuildReport()
    {
        ...
        [
            ...
            new("Super CP", "dashboard shell", "ecomae.com/CP", "/CP", "shell-placeholder", "ASP.NET Core route renders equivalent dashboard shell, menu, tenant selector, and access denial behavior."),
            new("Platform ERP", "finance dashboard", "ecomae.com/ERP", "/ERP", "shell-placeholder", "ASP.NET Core route matches finance dashboard KPIs, chart of accounts, vouchers, invoices, inventory, and reports."),
            new("Super BOS", "operations command center", "ecomae.com/BOS", "/BOS", "shell-placeholder", "ASP.NET Core route matches privileged BOS operations, audit logging, tenant fleet health, and rollback safety."),
