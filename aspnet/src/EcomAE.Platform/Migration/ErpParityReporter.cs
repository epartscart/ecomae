...
public sealed class ErpParityReporter : IErpParityReporter
{
    public ErpParityReport BuildReport()
    {
        return new ErpParityReport(
            ...
            "suppliers-purchases-digests-session-gated-awaiting-staging",
            [
                ...
                "Read-only /erp/dashboard-summary, /erp/accounts-summary, /erp/suppliers, and /erp/purchases digests are wired.",
