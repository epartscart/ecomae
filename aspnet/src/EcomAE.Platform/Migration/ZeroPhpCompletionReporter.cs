    ...
    public ZeroPhpCompletionReport BuildReport()
    {
        ...
        return new ZeroPhpCompletionReport(
            ...
            gate.ReadyToRemovePhp
                ...
                :
                [
                    "Redeploy smoke-issuer branch: bash scripts/cloudpanel_redeploy_final_gate_branch.sh (or ECOMAE_BRANCH=cursor/smoke-issuer-php-platform-pdo-7b3b bash scripts/cloudpanel_find_and_redeploy.sh). Use origin/main after PR merge.",
