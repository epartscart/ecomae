...
public sealed class AspNetZeroPhpPathReporter : IAspNetZeroPhpPathReporter
{
    public AspNetZeroPhpPathReport BuildReport()
    {
        ...
        [
            ...
            new("4-function-parity", "Interactive module writes/menus/flows", "in-progress", "aspNetInteractiveComplete=0; full ajax_erp.php catalog (321) via dedicated+registry dry-runs; concurrency/BOS/OPL/PF/AML/bank dry-runs; on-premises setup-wizard/backup scaffolds; write-dryrun dual-sample operator floor; live writes still PHP."),
