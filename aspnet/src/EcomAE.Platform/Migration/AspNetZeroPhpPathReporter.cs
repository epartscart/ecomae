...
public sealed class AspNetZeroPhpPathReporter : IAspNetZeroPhpPathReporter
{
    public AspNetZeroPhpPathReport BuildReport()
    {
        ...
        [
            ...
            new("2-scaffold", "ASP.NET digests + hybrid shells", "complete", "128 surface digests + storefront digests + ~159 presentation apps on www."),
            new("3-presentation-parity", "Same-to-same chrome (fonts/CSS/heroes/menus)", "in-progress", "Most marketing solutions nav scaffolded (incl. customer-results/continuity/free-tools/guides); CP/ERP/BOS/storefront hybrid on www; tenants PHP-primary under parity gate."),
            new("4-function-parity", "Interactive module writes/menus/flows", "in-progress", "aspNetInteractiveComplete=0; cart/quote/garage + OMS status/message/courier/delete + ERP cash/GL/purchase/invoice/SO/PO dry-runs; live writes still PHP."),
        ...
        return new AspNetZeroPhpPathReport(
            ...
            [
                ...
                "Dual-sample OMS delete + ERP void/cancel/PO delete dry-runs vs PHP ajax, then promote.",
                "API services/docs scaffolds; per-tenant storefront theme parity (epartscart first).",
