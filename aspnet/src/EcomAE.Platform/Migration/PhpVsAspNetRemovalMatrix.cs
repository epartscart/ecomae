...
public static class PhpVsAspNetRemovalMatrix
{
    ...
    [
        ...
        Row("cp-catalogue", "cp", "cp/content/shop/catalogue", "/CP/shop/catalogue/products", "/cp/product-catalogue-app", "aspnet-digest", "aspnet", "shop_catalogue_products min_limit / min_limit_enable UPDATEs and shop_catalogue_categories_templates create/delete are ASP.NET-live. Tree / SKU / media / template file upload stay PHP."),
