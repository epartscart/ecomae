...
public static class PhpVsAspNetRemovalMatrix
{
    ...
    [
        ...
        Row("erp-wms-locations", "erp", "content/shop/finance/epc_erp_wms.php epc_wms_location_delete", "/ERP/?epc_erp_shell=1&area=warehouse&tab=wms", "/cp/warehouse-wms-app", "aspnet-digest", "aspnet", "WMS location DELETE is ASP.NET-live when the bin holds no active LP stock. Schema ensure stays PHP."),
        ...
        Row("erp-subscriptions", "erp", "content/shop/finance/epc_erp_subscriptions.php epc_sub_set_status", "/ERP/?epc_erp_shell=1&area=sales&tab=subscriptions", "/erp/sales-orders-app?tab=subscriptions", "aspnet-digest", "aspnet", "Subscription status UPDATE is ASP.NET-live. Save, generate, and invoice-paid stay PHP."),
        ...
        Row("erp-procurement-reqs", "erp", "content/shop/finance/epc_erp_procurement.php epc_proc_req_submit/decision", "/ERP/?epc_erp_shell=1&area=purchasing&tab=purchase_requisitions", "/cp/purchase-requests-app", "aspnet-digest", "aspnet", "Requisition submit (policy auto-approve) and approve/reject are ASP.NET-live. Save, add-line, convert, and schema ensure stay PHP."),
