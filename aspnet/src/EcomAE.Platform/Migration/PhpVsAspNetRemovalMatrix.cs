...
public static class PhpVsAspNetRemovalMatrix
{
    ...
    [
        ...
        Row("erp-jw-repairs", "erp", "ajax_erp.php jw_repair_create/update_status", "/ERP/?epc_erp_shell=1&area=service_mgmt&tab=jw_repairs", "/cp/jewellery-repairs-app", "aspnet-digest", "aspnet", "epc_erp_jw_repairs INSERT and status UPDATE are ASP.NET-live. Sample seed stays PHP."),
        Row("erp-tabs-residual", "erp", "cp/content/shop/finance/erp/erp_tabs_*.php (~160)", "/ERP/?epc_erp_shell=1", "/erp", "aspnet-hub", "php", "Bare ERP shell lands on /erp. ErpPhpTabRouteMap covers named tabs; residual shells use /erp/module-app. Customer master, customer/order settlement, aftersales RMA create/resolve, warranty register, service-job create, job line add, job close, jewellery repair create, karat save, rate-type save, currency save, diamond save, design save, pearl save, color-stone save, barcode generate, tag create/sell, gold-scheme create/enroll/pay, fix/unfix create/settle, barcode-purchase create/sell, SLA create, ticket create, customer-group create/assign, report-scheduler create, metal-stock save, fixing save, voucher save, petty-cash save, tourist-VAT save, repair-receipt save, repair-transfer save, workshop-receive save, repair-delivery save, stock-verification save, repair-sale voucher, POS-advance voucher, and journal voucher are ASP.NET-live."),
