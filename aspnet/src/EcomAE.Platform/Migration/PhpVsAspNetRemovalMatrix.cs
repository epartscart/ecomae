...
public static class PhpVsAspNetRemovalMatrix
{
    ...
    [
        ...
        Row("erp-fy-reopen-period", "erp", "content/shop/finance/epc_erp_closing.php epc_fy_reopen_year + epc_fy_set_period_status + content/shop/finance/epc_erp_period_close.php epc_erp_period_soft_close", "/ERP/?epc_erp_shell=1&area=finance&tab=year_end", "/erp/period-close-app", "aspnet-digest", "aspnet", "Fiscal-year reopen, period status, and monthly soft-close UPDATEs are ASP.NET-live. Year create, year-end close, monthly period lock/reopen, and schema ensure stay PHP."),
