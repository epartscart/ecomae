...
public static class PhpVsAspNetRemovalMatrix
{
    ...
    [
        ...
        Row("erp-workspace-favorites", "erp", "ajax_erp.php erp_fav_add/remove", "/ERP/?epc_erp_shell=1&area=overview&tab=favorites", "/erp/workspace-favorites-app", "aspnet-digest", "aspnet", "epc_erp_favourites INSERT IGNORE / DELETE are ASP.NET-live. Shortcut pin/reorder and schema ensure stay PHP."),
