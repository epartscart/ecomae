...
public static class PhpVsAspNetRemovalMatrix
{
    ...
    [
        ...
        Row("erp-fin-period-status", "erp", "content/shop/finance/epc_erp_fin_advanced.php epc_fin_period_set_status + epc_fin_periods_generate", "/ERP/?epc_erp_shell=1&area=cost_acct&tab=fin_advanced", "/cp/fin-advanced-app", "aspnet-digest", "aspnet", "Advanced finance period status UPDATE and period generate INSERT are ASP.NET-live. FX/alloc/accrual writes, and schema ensure stay PHP."),
