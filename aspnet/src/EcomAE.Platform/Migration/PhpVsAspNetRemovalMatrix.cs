...
public static class PhpVsAspNetRemovalMatrix
{
    ...
    [
        ...
        Row("cp-prices-upload", "cp", "cp/content/shop/prices_upload", "/CP/shop/prices_upload", "/cp/prices-upload-app", "aspnet-digest", "aspnet", "ajax_6_complete_session last_updated / records_count and min_price_acl_save UPSERT are ASP.NET-live. CSV import, file ingest, extract, and sitemap stay PHP."),
