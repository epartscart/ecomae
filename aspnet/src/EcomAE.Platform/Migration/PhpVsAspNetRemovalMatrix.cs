...
public static class PhpVsAspNetRemovalMatrix
{
    ...
    [
        ...
        Row("erp-collections-cases", "erp", "content/shop/finance/epc_erp_collections.php epc_coll_case_save epc_coll_case_set_status epc_coll_case_promise epc_coll_activity_log epc_coll_hold_set", "/ERP/?epc_erp_shell=1&area=finance&tab=collections", "/erp/collections-dunning-app", "aspnet-digest", "aspnet", "Collections case save, status, promise, activity log, and credit hold are ASP.NET-live. Dunning run stays PHP."),
