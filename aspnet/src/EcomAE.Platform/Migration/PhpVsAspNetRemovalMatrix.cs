...
public static class PhpVsAspNetRemovalMatrix
{
    ...
    [
        ...
        Row("cp-catalogue", "cp", "cp/content/shop/catalogue", "/CP/shop/catalogue/products", "/cp/product-catalogue-app", "aspnet-digest", "aspnet", "shop_catalogue_products min_limit / min_limit_enable UPDATEs, shop_catalogue_categories_templates create/delete, epc_sku_profiles / spec groups+rows / photo-meta, and shop_main_page_groups/products save are ASP.NET-live. Catalogue tree, SKU photo file upload, item images, template file upload, and drag-tree UX stay PHP."),
