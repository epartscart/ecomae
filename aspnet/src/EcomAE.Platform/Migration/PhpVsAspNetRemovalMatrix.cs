...
public static class PhpVsAspNetRemovalMatrix
{
    ...
    [
        ...
        Row("erp-collections-cases", "erp", "content/shop/finance/epc_erp_collections.php epc_coll_case_set_status", "/ERP/?epc_erp_shell=1&area=finance&tab=collections", "/erp/collections-dunning-app", "aspnet-digest", "aspnet", "Collections case status UPDATE is ASP.NET-live. Case save, promise, activity, dunning run, and hold stay PHP."),
        Row("erp-procurement-reqs", "erp", "content/shop/finance/epc_erp_procurement.php epc_proc_req_submit/decision/convert", "/ERP/?epc_erp_shell=1&area=purchasing&tab=purchase_requisitions", "/erp/purchase-requests-app", "aspnet-digest", "aspnet", "Requisition submit, approve/reject, and convert-to-PO are ASP.NET-live. Save, add-line, and schema ensure stay PHP."),
        Row("erp-ins-claims", "erp", "content/shop/finance/epc_erp_insurance.php epc_ins_claim_set_status + epc_ins_doc_delete", "/ERP/?epc_erp_shell=1&area=risk&tab=insurance", "/erp/insurance-compliance-app", "aspnet-digest", "aspnet", "Insurance claim status UPDATE and document DELETE are ASP.NET-live. Policy save/delete, doc add, and claim add stay PHP."),
        Row("erp-hr-leave-expense", "erp", "content/shop/finance/epc_erp_hr.php epc_hr_expense_save + epc_hr_leave_set_status + epc_hr_expense_set_status", "/ERP/?epc_erp_shell=1&area=people&tab=hr", "/erp/hr-overview-app", "aspnet-digest", "aspnet", "HR expense save INSERT and leave/expense status UPDATEs are ASP.NET-live. Leave request, employee save, and schema ensure stay PHP."),
        Row("erp-cons-deletes", "erp", "content/shop/finance/epc_erp_consolidation.php epc_cons_entity_delete + epc_cons_ic_delete", "/ERP/?epc_erp_shell=1&area=consolidations&tab=consolidation_bu", "/erp/consolidations-app", "aspnet-digest", "aspnet", "Consolidation entity and IC DELETEs are ASP.NET-live. Save, figures, and schema ensure stay PHP."),
        ...
        Row("erp-jw-repairs", "erp", "ajax_erp.php jw_repair_update_status", "/ERP/?epc_erp_shell=1&area=service_mgmt&tab=jw_repairs", "/erp/jewellery-repairs-app", "aspnet-digest", "aspnet", "epc_erp_jw_repairs status UPDATE is ASP.NET-live. Create and sample seed stay PHP."),
