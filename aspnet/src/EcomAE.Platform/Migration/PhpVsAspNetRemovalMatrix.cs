...
public static class PhpVsAspNetRemovalMatrix
{
    ...
    [
        ...
        Row("erp-fy-reopen-period", "erp", "content/shop/finance/epc_erp_closing.php epc_fy_reopen_year + epc_fy_set_period_status + epc_erp_fiscal_set_lock", "/ERP/?epc_erp_shell=1&area=finance&tab=year_end", "/erp/period-close-app", "aspnet-digest", "aspnet", "Fiscal-year reopen, period status, and GL fiscal-lock writes are ASP.NET-live. Year create, year-end close, monthly period soft-close/lock/reopen, audit, and schema ensure stay PHP."),
