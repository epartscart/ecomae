...
public static class PhpVsAspNetRemovalMatrix
{
    ...
    [
        ...
        Row("erp-fy-reopen-period", "erp", "content/shop/finance/epc_erp_closing.php epc_fy_reopen_year + epc_fy_set_period_status + epc_fy_create_year", "/ERP/?epc_erp_shell=1&area=finance&tab=year_end", "/erp/period-close-app", "aspnet-digest", "aspnet", "Fiscal-year create UPSERT, reopen, and period status UPDATEs are ASP.NET-live. Year-end close and schema ensure stay PHP."),
