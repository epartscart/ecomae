...
public static class PhpVsAspNetRemovalMatrix
{
    ...
    [
        ...
        Row("cp-storages", "cp", "cp/content/shop/logistics/groups", "/CP/shop/logistics/storages", "/cp/storages-app", "aspnet-digest", "aspnet", "shop_storages_groups add/delete and shop_storages create/edit are ASP.NET-live. Membership UI stays PHP."),
