...
public static class PhpVsAspNetRemovalMatrix
{
    ...
    [
        ...
        Row("erp-wms-locations", "erp", "content/shop/finance/epc_erp_wms.php epc_wms_location_delete + epc_wms_wave_release + epc_wms_wave_create + epc_wms_receive", "/ERP/?epc_erp_shell=1&area=warehouse&tab=wms", "/erp/warehouse-wms-app", "aspnet-digest", "aspnet", "WMS receive INSERT, location DELETE, wave create+pick, and wave release are ASP.NET-live. Work complete and schema ensure stay PHP."),
        ...
        Row("erp-hr-leave-expense", "erp", "content/shop/finance/epc_erp_hr.php epc_hr_leave_set_status + epc_hr_expense_set_status", "/ERP/?epc_erp_shell=1&area=people&tab=hr", "/erp/hr-overview-app", "aspnet-digest", "aspnet", "HR leave and expense status UPDATEs are ASP.NET-live. Leave request, expense save, and schema ensure stay PHP."),
