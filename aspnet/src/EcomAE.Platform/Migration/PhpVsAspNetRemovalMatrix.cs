...
public static class PhpVsAspNetRemovalMatrix
{
    ...
    [
        ...
        Row("cp-price-storage-rules", "cp", "cp/content/shop/pricing/epc_pm_storage_panel.php", "/CP/shop/prices", "/cp/price-lists-app", "aspnet-digest", "aspnet", "Price-storage rule DELETEs are ASP.NET-live. Save/upsert stay PHP."),
