...
public static class PhpVsAspNetRemovalMatrix
{
    ...
    [
        ...
        Row("erp-multi-currency-gl", "erp", "content/shop/finance/epc_multi_currency_gl.php + epc_ccy_set_rate", "/CP/shop/finance/epc_multi_currency_gl", "/erp/multi-currency-gl-app", "aspnet-digest", "aspnet", "epc_mcgl_set_rate and BOS dated epc_ccy_set_rate UPSERTs are ASP.NET-live. Revaluation, journal entry, and seed stay PHP."),
