...
public static class PhpVsAspNetRemovalMatrix
{
    ...
    [
        ...
        Row("cp-pos", "cp", "cp/content/shop/pos/ajax_pos.php", "/CP/control/shop/pos", "/cp/pos-overview-app", "aspnet-digest", "aspnet", "open_session / close_session / save_settings and complete_sale sale/line INSERT are ASP.NET-live. Walk-in user create is ASP.NET-live. Printable receipt HTML is ASP.NET-live at /cp/pos/receipt/{id}. Tax-toolkit totals, ERP SO/invoice/voucher, and inventory stay PHP."),
