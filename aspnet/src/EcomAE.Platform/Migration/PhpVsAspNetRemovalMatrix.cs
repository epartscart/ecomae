...
public static class PhpVsAspNetRemovalMatrix
{
    ...
    [
        ...
        // CP shop families
        Row("cp-orders", "cp", "cp/content/shop/orders + order_process", "/CP/shop/orders/orders", "/cp/orders", "aspnet-digest", "aspnet", "OMS item/items status, update_item/update_items (including warehouse reprice), refresh_item_cost, message, courier, delete, comment, viewed, supplier fulfillment stage, and pay-refund are ASP.NET-live. Customer-group sell markup and refund email stay PHP."),
