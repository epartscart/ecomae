...
public static class PhpVsAspNetRemovalMatrix
{
    ...
    [
        ...
        Row("erp-wms-locations", "erp", "content/shop/finance/epc_erp_wms.php epc_wms_location_save + epc_wms_location_delete + epc_wms_wave_create + epc_wms_wave_release", "/ERP/?epc_erp_shell=1&area=warehouse&tab=wms", "/cp/warehouse-wms-app", "aspnet-digest", "aspnet", "WMS location save INSERT/UPDATE, location DELETE, wave create+pick, and wave release are ASP.NET-live. Receive, work complete, and schema ensure stay PHP."),
        ...
        Row("cp-collections", "cp", "content/shop/finance/epc_collections_dunning.php", "/CP/shop/finance/epc_collections_dunning", "/cp/collections-dunning-app", "aspnet-digest", "aspnet", "epc_dunning_update_status and epc_dunning_record_payment are ASP.NET-live. Letter process, profiles, add-invoice, and assign stay PHP. Case status stays on the ERP collections twin."),
        ...
        Row("erp-contracts", "erp", "content/shop/finance/epc_erp_contracts.php epc_ctr_save + epc_ctr_set_status", "/ERP/?epc_erp_shell=1&area=sales&tab=contracts", "/erp/contracts-app", "aspnet-digest", "aspnet", "Contract save INSERT/UPDATE and status UPDATE are ASP.NET-live. Sign, OCR, and schema ensure stay PHP."),
