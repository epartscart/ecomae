...
public static class PhpVsAspNetRemovalMatrix
{
    ...
    [
        ...
        Row("cp-fulfillment", "cp", "content/shop/finance/epc_fulfillment_queue.php", "/CP/shop/finance/epc_fulfillment_queue", "/cp/fulfillment-queue-app", "aspnet-digest", "aspnet", "transition / assign / pick_item / pack_item / create_wave are ASP.NET-live. Queue-from-order INSERT and packing-slip PDF stay PHP."),
        Row("cp-pos", "cp", "cp/content/shop/pos/ajax_pos.php", "/CP/control/shop/pos", "/cp/pos-overview-app", "aspnet-digest", "aspnet", "open_session / close_session / save_settings and complete_sale sale/line INSERT are ASP.NET-live. Walk-in user, tax-toolkit totals, ERP SO/invoice/voucher, inventory, and receipt HTML stay PHP."),
        Row("cp-collections", "cp", "content/shop/finance/epc_collections_dunning.php", "/CP/shop/finance/epc_collections_dunning", "/cp/collections-dunning-app", "aspnet-digest", "aspnet", "Queue status / payment are ASP.NET-live on /cp/collections-dunning/write. Letter process, profiles, and add-invoice stay PHP. Case status writes live on the ERP collections twin."),
