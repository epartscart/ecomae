...
public static class PhpVsAspNetRemovalMatrix
{
    ...
    [
        ...
        Row("cp-content-pages", "cp", "cp/content/content/content_manager.php + content.php", "/CP/content/content_manager", "/cp/pages-app", "aspnet-digest", "aspnet", "Single-id published_flag, main_flag, and save_content body (text/php) are ASP.NET-live. TinyMCE image upload and system-content config stay PHP."),
