...
public static class PhpVsAspNetRemovalMatrix
{
    ...
    [
        ...
        Row("erp-inventory", "erp", "erp_tabs_inventory.php", "/ERP/?epc_erp_shell=1&area=inventory&tab=inventory", "/erp/inventory-stock-app", "aspnet-digest", "aspnet", "inv_set_reorder_level, inv_record_movement, and inv_transfer are ASP.NET-live. CSV import, warehouse/item create, and closing stay PHP."),
