...
public static class PhpVsAspNetRemovalMatrix
{
    ...
    [
        ...
        Row("erp-wms-locations", "erp", "content/shop/finance/epc_erp_wms.php epc_wms_location_delete + epc_wms_wave_release + epc_wms_receive", "/ERP/?epc_erp_shell=1&area=warehouse&tab=wms", "/cp/warehouse-wms-app", "aspnet-digest", "aspnet", "WMS receive INSERT, location DELETE, and wave release UPDATE are ASP.NET-live. Wave create, pick add, work complete, and schema ensure stay PHP."),
