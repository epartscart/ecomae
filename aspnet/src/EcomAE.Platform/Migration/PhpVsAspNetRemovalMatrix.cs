...
public static class PhpVsAspNetRemovalMatrix
{
    ...
    [
        ...
        Row("erp-bos-wf-disable-rule", "erp", "content/shop/finance/epc_bos_workflow.php epc_bos_wf_disable_rule + epc_bos_wf_decide", "/ERP/?epc_erp_shell=1&area=overview&tab=approvals", "/erp/approvals-app", "aspnet-digest", "aspnet", "BOS approval-rule disable UPDATE and request decide UPDATE are ASP.NET-live. Save, raise, and schema ensure stay PHP."),
