...
public static class PhpVsAspNetRemovalMatrix
{
    ...
    [
        ...
        Row("erp-cons-deletes", "erp", "content/shop/finance/epc_erp_consolidation.php epc_cons_entity_save + epc_cons_entity_delete + epc_cons_ic_delete + epc_cons_ic_save", "/ERP/?epc_erp_shell=1&area=consolidations&tab=consolidation_bu", "/erp/consolidations-app", "aspnet-digest", "aspnet", "Consolidation entity save, entity DELETE, IC DELETE, and IC save INSERT are ASP.NET-live. Figures and schema ensure stay PHP."),
