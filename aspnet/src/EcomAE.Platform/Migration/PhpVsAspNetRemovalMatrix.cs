...
public static class PhpVsAspNetRemovalMatrix
{
    ...
    [
        ...
        Row("erp-tabs-residual", "erp", "cp/content/shop/finance/erp/erp_tabs_*.php (~160)", "/ERP/?epc_erp_shell=1", "/erp", "aspnet-hub", "php", "Bare ERP shell lands on /erp. ErpPhpTabRouteMap covers named tabs; residual shells use /erp/module-app. Customer master, customer/order settlement, and aftersales RMA create are ASP.NET-live."),
