...
public static class PhpVsAspNetRemovalMatrix
{
    ...
    [
        ...
        Row("cp-catalogue", "cp", "cp/content/shop/catalogue", "/CP/shop/catalogue/products", "/cp/product-catalogue-app", "aspnet-digest", "aspnet", "shop_catalogue_products min_limit / min_limit_enable UPDATEs, shop_catalogue_categories_templates create/delete, and epc_sku_profiles save/ensure/delete are ASP.NET-live. Catalogue tree, SKU photos/specs, item images, and template file upload stay PHP."),
