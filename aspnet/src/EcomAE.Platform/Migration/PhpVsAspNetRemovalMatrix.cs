...
public static class PhpVsAspNetRemovalMatrix
{
    ...
    [
        ...
        Row("erp-hr-leave-expense", "erp", "content/shop/finance/epc_erp_hr.php epc_hr_leave_request + epc_hr_expense_save + epc_hr_leave_set_status + epc_hr_expense_set_status", "/ERP/?epc_erp_shell=1&area=people&tab=hr", "/erp/hr-overview-app", "aspnet-digest", "aspnet", "HR leave request INSERT, expense save INSERT, and leave/expense status UPDATEs are ASP.NET-live. Employee save and schema ensure stay PHP."),
