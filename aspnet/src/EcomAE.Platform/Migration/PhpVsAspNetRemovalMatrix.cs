...
public static class PhpVsAspNetRemovalMatrix
{
    ...
    [
        ...
        Row("erp-contracts", "erp", "content/shop/finance/epc_erp_contracts.php epc_ctr_save + epc_ctr_set_status + epc_ctr_sign", "/ERP/?epc_erp_shell=1&area=sales&tab=contracts", "/erp/contracts-app", "aspnet-digest", "aspnet", "Contract save INSERT/UPDATE, status UPDATE, and e-sign INSERT are ASP.NET-live. OCR and schema ensure stay PHP."),
