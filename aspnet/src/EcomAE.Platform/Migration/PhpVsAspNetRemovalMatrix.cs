...
public static class PhpVsAspNetRemovalMatrix
{
    ...
    [
        ...
        Row("cp-offices", "cp", "cp/content/shop/logistics/office.php + offices.php", "/CP/shop/logistics/offices", "/cp/offices-app", "aspnet-digest", "aspnet", "shop_offices create/edit (lang strings + caption/country/region/city/address/phone/email/coordinates/description/users/timetable) and delete (shop_offices + storages_map + geo_map) are ASP.NET-live."),
