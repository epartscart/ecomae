...
public static class PhpVsAspNetRemovalMatrix
{
    ...
    [
        ...
        Row("erp-payroll", "erp", "content/shop/finance/epc_erp_payroll.php epc_erp_payroll_generate_run + epc_erp_payroll_approve_run + epc_erp_payroll_update_line_days + hr_update_days", "/CP/shop/finance/epc_wps_payroll", "/erp/payroll-app", "aspnet-digest", "aspnet", "Payroll generate INSERT/rebuild, approve UPDATE, line-days recalc, and hr_update_days are ASP.NET-live. Pay stays PHP. Schema ensure stays PHP."),
