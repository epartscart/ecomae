...
public static class PhpVsAspNetRemovalMatrix
{
    ...
    [
        ...
        Row("sf-balance", "storefront", "content/shop/finance/my_balance.php", "/shop/finance/my_balance", "/storefront/account-summary-app", "aspnet-routed", "aspnet", "ajax_create_operation top-up / order-pay is ASP.NET-live. Guest checkout cookies stay PHP."),
        ...
        // CP shop families
        Row("cp-orders", "cp", "cp/content/shop/orders + order_process", "/CP/shop/orders/orders", "/cp/orders", "aspnet-digest", "aspnet", "OMS item/items status, update_item/update_items, refresh_item_cost, message, courier, delete, comment, viewed, supplier fulfillment stage, and pay-refund are ASP.NET-live. update_item warehouse reprice flag, customer-group sell markup, and refund email stay PHP."),
