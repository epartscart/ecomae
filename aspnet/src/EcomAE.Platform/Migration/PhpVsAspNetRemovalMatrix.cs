...
public static class PhpVsAspNetRemovalMatrix
{
    ...
    [
        ...
        Row("cp-workshop", "cp", "cp/content/shop/workshop", "/CP/shop/workshop", "/cp/workshop-app", "aspnet-digest", "aspnet", "Open ?job_id= loads 280-char notes/complaint excerpts. assign / save_bay / save_tech / set_status / create_job / add_line / create_appointment / convert_appointment are ASP.NET-live. Seed stays PHP."),
