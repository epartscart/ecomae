...
public static class PhpVsAspNetRemovalMatrix
{
    ...
    [
        ...
        Row("erp-payroll", "erp", "content/shop/finance/epc_erp_payroll.php epc_erp_payroll_approve_run + epc_erp_payroll_pay_run + hr_update_days", "/CP/shop/finance/epc_wps_payroll", "/erp/payroll-app", "aspnet-digest", "aspnet", "Payroll approve, pay (cash entry + paid status), and hr_update_days are ASP.NET-live. Generate and line-days recalc stay PHP. Schema ensure and COA GL stay PHP."),
