...
public static class PhpVsAspNetRemovalMatrix
{
    ...
    [
        ...
        Row("erp-pf-case-cancel", "erp", "content/shop/finance/epc_erp_processflow.php epc_pf_case_cancel + epc_pf_step_delete + epc_pf_set_dept_head + epc_pf_case_reassign + epc_pf_process_save + epc_pf_step_save", "/ERP/?epc_erp_shell=1&area=overview&tab=processflow", "/erp/process-flow-tasks-app", "aspnet-digest", "aspnet", "Process-flow monitor/inbox/org tabs match Classic twin presentation. Case cancel UPDATE, step DELETE, department-head UPSERT, reassign, process save, and step save are ASP.NET-live. Start, act, seed, and schema ensure stay PHP."),
