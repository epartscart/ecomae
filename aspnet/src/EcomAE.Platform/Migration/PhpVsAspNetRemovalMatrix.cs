...
public static class PhpVsAspNetRemovalMatrix
{
    ...
    [
        ...
        Row("erp-collections-cases", "erp", "content/shop/finance/epc_erp_collections.php epc_coll_case_save epc_coll_case_set_status", "/ERP/?epc_erp_shell=1&area=finance&tab=collections", "/cp/collections-dunning-app", "aspnet-digest", "aspnet", "Collections case save INSERT/UPDATE and status UPDATE are ASP.NET-live. Promise, activity, dunning run, and hold stay PHP."),
