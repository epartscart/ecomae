...
public sealed class LiveSurfaceLinkReporter : ILiveSurfaceLinkReporter
{
    public LiveSurfaceLinkReport BuildReport()
    {
        ...
        [
            ...
            Link("aspnet-exact-route-shadow-live", "CP users digest", "https://www.ecomae.com/cp/users", "aspnet", "/cp/users", "Live exact-route nginx shadow on www (unauth 401 unauthorized). Installer may briefly see CDN-cached PHP HTML 200 — re-probe public."),
            Link("aspnet-exact-route-shadow-live", "CP groups digest", "https://www.ecomae.com/cp/groups", "aspnet", "/cp/groups", "Live exact-route nginx shadow on www (unauth 401 unauthorized; admin CP capability for 200). Surface digests 4/30."),
        ...
        return new LiveSurfaceLinkReport(
            ...
            [
                ...
                "Wired catalog exact-routes complete (18/18). Surface digests: 4/30 live (cp/dashboard-summary, cp/tenants, cp/users, cp/groups).",
                "Next exact-route: ECOMAE_CONFIRM_INSTALL_EXACT_ROUTE_SHADOW=YES bash scripts/cloudpanel_install_exact_route_shadow.sh /cp/modules",
                "Then continue digests from deploy/aspnet/nginx-surface-digests-shadow-example.conf (menus, pages, …) one location= at a time. Never broad /cp|/erp|/bos.",
