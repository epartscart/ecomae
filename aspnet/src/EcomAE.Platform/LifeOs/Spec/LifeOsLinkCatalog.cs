...
public static class LifeOsLinkCatalog
{
    ...
    [
        ...
        new("frontend", 1, "Joined clients board (no login)", "/lifeos/clients-board", "GET", "www + lifeos", "How joined · country · device · activity · results links"),
        new("frontend", 1, "CP joined clients console", "/cp/lifeos-clients-app", "GET", "www CP (allowlisted, no login yet)", "Same board under /cp · temporary public"),
