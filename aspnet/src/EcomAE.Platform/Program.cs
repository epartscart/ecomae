...
builder.Services.AddScoped<EcomAE.Platform.Cp.ICpLangConfiguratorService, EcomAE.Platform.Cp.CpLangConfiguratorService>();
...
builder.Services.AddScoped<EcomAE.Platform.Bos.IBosWebhookWriteService, EcomAE.Platform.Bos.BosWebhookWriteService>();
builder.Services.AddScoped<EcomAE.Platform.Bos.IBosPoWriteService, EcomAE.Platform.Bos.BosPoWriteService>();
builder.Services.AddScoped<EcomAE.Platform.Bos.IBosFulfillmentWriteService, EcomAE.Platform.Bos.BosFulfillmentWriteService>();
builder.Services.AddScoped<EcomAE.Platform.Bos.IBosBillingWriteService, EcomAE.Platform.Bos.BosBillingWriteService>();
builder.Services.AddScoped<EcomAE.Platform.Bos.IBosRmaWriteService, EcomAE.Platform.Bos.BosRmaWriteService>();
builder.Services.AddScoped<EcomAE.Platform.Bos.IBosDealerWriteService, EcomAE.Platform.Bos.BosDealerWriteService>();
builder.Services.AddScoped<EcomAE.Platform.Bos.IBosDunningWriteService, EcomAE.Platform.Bos.BosDunningWriteService>();
builder.Services.AddScoped<EcomAE.Platform.Bos.IBosSsoWriteService, EcomAE.Platform.Bos.BosSsoWriteService>();
...
builder.Services.AddScoped<EcomAE.Platform.Bos.IBosPayrollWriteService, EcomAE.Platform.Bos.BosPayrollWriteService>();
builder.Services.AddScoped<EcomAE.Platform.Bos.IBosSoc2WriteService, EcomAE.Platform.Bos.BosSoc2WriteService>();
builder.Services.AddScoped<EcomAE.Platform.Bos.IBosWorkflowWriteService, EcomAE.Platform.Bos.BosWorkflowWriteService>();
builder.Services.AddScoped<EcomAE.Platform.Bos.IBosVaultWriteService, EcomAE.Platform.Bos.BosVaultWriteService>();
builder.Services.AddScoped<EcomAE.Platform.Bos.IBosImportWriteService, EcomAE.Platform.Bos.BosImportWriteService>();
builder.Services.AddScoped<EcomAE.Platform.Bos.IBosNlReportingWriteService, EcomAE.Platform.Bos.BosNlReportingWriteService>();
builder.Services.AddScoped<EcomAE.Platform.Bos.IBosDesignTokenWriteService, EcomAE.Platform.Bos.BosDesignTokenWriteService>();
builder.Services.AddScoped<EcomAE.Platform.Bos.IBosTenantConfigWriteService, EcomAE.Platform.Bos.BosTenantConfigWriteService>();
builder.Services.AddScoped<EcomAE.Platform.Bos.IBosAiClassWriteService, EcomAE.Platform.Bos.BosAiClassWriteService>();
builder.Services.AddScoped<EcomAE.Platform.Bos.IBosMfaWriteService, EcomAE.Platform.Bos.BosMfaWriteService>();
builder.Services.AddScoped<EcomAE.Platform.Bos.IBosIndustryWriteService, EcomAE.Platform.Bos.BosIndustryWriteService>();
...
builder.Services.AddScoped<EcomAE.Platform.Cp.ICpCrmExpenseWriteService, EcomAE.Platform.Cp.CpCrmExpenseWriteService>();
builder.Services.AddScoped<EcomAE.Platform.Cp.ICpDocumentControlWriteService, EcomAE.Platform.Cp.CpDocumentControlWriteService>();
...
builder.Services.AddScoped<EcomAE.Platform.Cp.ICpBulkUploadHubService, EcomAE.Platform.Cp.CpBulkUploadHubService>();
