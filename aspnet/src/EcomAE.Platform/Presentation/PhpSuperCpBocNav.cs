...
public static class PhpSuperCpBocNav
{
    ...
    [
        ...
        new("erp_ap", "Accounts payable", "erp", "fa-credit-card", "shop/finance/erp?epc_erp_shell=1&area=ap&tab=payables", "AP"),
        new("erp_ar", "Accounts receivable", "erp", "fa-users", "shop/finance/erp?epc_erp_shell=1&area=ar&tab=receivables", "AR"),
        ...
        new("erp_sales", "Sales & CRM", "erp", "fa-line-chart", "shop/finance/erp?epc_erp_shell=1&area=sales&tab=sales_orders", "Sales orders"),
        new("erp_purchasing", "Purchasing", "erp", "fa-shopping-basket", "shop/finance/erp?epc_erp_shell=1&area=purchasing&tab=purchase_orders", "POs"),
