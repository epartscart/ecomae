...
public static class PhpSurfaceLinkMap
{
    ...
    [
        ...
        ("control/portal/epc_super_cp_customer_board", "/cp/customer-board-app"),
        ...
        ("control/portal/epc_social_media_hub", "/cp/social-hub-app"),
        ("control/portal/industry_settings", "/cp/industry-packs-app"),
        ("control/portal/epc_free_tools", "/cp/free-tools-app"),
        ("control/portal/epc_free_tools_admin", "/cp/free-tools-app"),
        ...
        ("shop/finance/epc_order_erp_pipeline", "/erp/order-pipeline-app"),
        ("shop/finance/epc_inventory_forecast", "/erp/inventory-forecast-app"),
        ("shop/finance/epc_multi_currency_gl", "/erp/multi-currency-gl-app"),
        ("shop/finance/epc_multi_entity", "/erp/multi-entity-app"),
        ("shop/finance/epc_currency_live_rates", "/cp/currencies-app"),
        ("shop/finance/epc_einvoice", "/cp/einvoice-documents-app"),
        ("shop/finance/epc_tax_toolkit", "/cp/tax-toolkits-app"),
        ("shop/finance/epc_insights_suite", "/erp/dashboard-summary-app"),
        ("shop/finance/epc_custom_shipping", "/cp/carriers-app"),
        ("shop/finance/payment_systems", "/cp/payment-gateways-app"),
        ("shop/finance/account_operations", "/cp/credit-limits-app"),
    ...
    public static string MapCpPhpPath(string value)
    {
        ...
        {
            return ErpRecordOpen.PreserveRecordQuery("/cp/menus-app", value);
        }
        ...
        {
            return ErpRecordOpen.PreserveRecordQuery("/cp/templates-manager-app", value);
        }
        ...
        foreach (var (marker, aspNet) in CpPathMap)
        {
                ...
                || path.Contains(marker, StringComparison.OrdinalIgnoreCase))
            {
                ...
                if (aspNet.Equals("/cp/collections-dunning-app", StringComparison.OrdinalIgnoreCase)
                    || aspNet.Equals("/cp/api-clients-app", StringComparison.OrdinalIgnoreCase)
                    || aspNet.Equals("/cp/einvoice-documents-app", StringComparison.OrdinalIgnoreCase)
                    ...
                    || aspNet.Equals("/cp/event-bus-app", StringComparison.OrdinalIgnoreCase)
                    || aspNet.Equals("/cp/ops-guides-app", StringComparison.OrdinalIgnoreCase)
                    || aspNet.Equals("/cp/marketplace-apps-app", StringComparison.OrdinalIgnoreCase)
                    || aspNet.Equals("/cp/nl-reporting-app", StringComparison.OrdinalIgnoreCase)
                    || aspNet.Equals("/cp/power-bi-app", StringComparison.OrdinalIgnoreCase)
                    || aspNet.Equals("/cp/metabase-app", StringComparison.OrdinalIgnoreCase)
                    || aspNet.Equals("/cp/marketing-growth-app", StringComparison.OrdinalIgnoreCase)
                    || aspNet.Equals("/cp/isolation-audit-app", StringComparison.OrdinalIgnoreCase)
                    || aspNet.Equals("/cp/industry-packs-app", StringComparison.OrdinalIgnoreCase)
                    || aspNet.Equals("/cp/config-sandbox-app", StringComparison.OrdinalIgnoreCase)
                    || aspNet.Equals("/cp/platform-governance-app", StringComparison.OrdinalIgnoreCase)
                    || aspNet.Equals("/cp/platform-communication-app", StringComparison.OrdinalIgnoreCase)
                    ...
                    || aspNet.Equals("/cp/consolidations-app", StringComparison.OrdinalIgnoreCase)
                    ...
                    || aspNet.Equals("/cp/auto-price-app", StringComparison.OrdinalIgnoreCase)
                    || aspNet.Equals("/cp/groups-app", StringComparison.OrdinalIgnoreCase)
                    || aspNet.Equals("/cp/credit-limits-app", StringComparison.OrdinalIgnoreCase)
                    || aspNet.Equals("/cp/workshop-app", StringComparison.OrdinalIgnoreCase)
                    || aspNet.Equals("/cp/jewellery-fixing-app", StringComparison.OrdinalIgnoreCase)
                    || aspNet.Equals("/erp/jewellery-fixing-app", StringComparison.OrdinalIgnoreCase)
                    || aspNet.Equals("/cp/crm-board-app", StringComparison.OrdinalIgnoreCase)
                    || aspNet.Equals("/erp/crm-board-app", StringComparison.OrdinalIgnoreCase)
                    || aspNet.Equals("/cp/jewellery-masters-app", StringComparison.OrdinalIgnoreCase)
                    || aspNet.Equals("/erp/jewellery-masters-app", StringComparison.OrdinalIgnoreCase)
                    ...
                    || aspNet.Equals("/erp/sales-quotations-app", StringComparison.OrdinalIgnoreCase)
                    || aspNet.Equals("/erp/marketing-app", StringComparison.OrdinalIgnoreCase)
                    || aspNet.Equals("/erp/rfq-app", StringComparison.OrdinalIgnoreCase)
                    || aspNet.Equals("/erp/delivery-notes-app", StringComparison.OrdinalIgnoreCase)
                    || aspNet.Equals("/erp/payment-batches-app", StringComparison.OrdinalIgnoreCase)
                    || aspNet.Equals("/erp/expense-reports-app", StringComparison.OrdinalIgnoreCase)
                    || aspNet.Equals("/erp/agenda-app", StringComparison.OrdinalIgnoreCase)
                    || aspNet.Equals("/erp/documents-app", StringComparison.OrdinalIgnoreCase)
                    || aspNet.Equals("/erp/print-designer-app", StringComparison.OrdinalIgnoreCase)
                    || aspNet.Equals("/erp/opening-app", StringComparison.OrdinalIgnoreCase)
                    || aspNet.Equals("/erp/period-close-app", StringComparison.OrdinalIgnoreCase)
                    || aspNet.Equals("/erp/contacts-app", StringComparison.OrdinalIgnoreCase)
                    || aspNet.Equals("/erp/rfid-app", StringComparison.OrdinalIgnoreCase)
                    || aspNet.Equals("/erp/coa-accounts-app", StringComparison.OrdinalIgnoreCase)
                    || aspNet.Equals("/erp/workspace-favorites-app", StringComparison.OrdinalIgnoreCase)
                    || aspNet.Equals("/erp/bank-reconciliation-app", StringComparison.OrdinalIgnoreCase)
                    ...
                    || aspNet.Equals("/erp/doc-attachments-app", StringComparison.OrdinalIgnoreCase)
                    || aspNet.Equals("/erp/order-planning-app", StringComparison.OrdinalIgnoreCase))
                {
    ...
    private static string MapErpPhpPath(string value)
    {
        ...
        var areaHref = areaKey switch
        {
            ...
            "credit_coll" => "/erp/collections-dunning-app",
            "inventory_mgmt" or "inventory" or "pim" => "/erp/inventory-stock-app",
            "logistics" => "/erp/fulfillment-queue-app",
            "warehouse" => "/erp/warehouses-app",
            "people" or "payroll" or "payroll_area" or "leave_abs" => "/erp/hr-overview-app",
            "tax" or "risk" => "/erp/vat-app",
            "production" or "master_planning_area" or "mhei" => "/erp/production-overview-app",
            "projects" => "/erp/projects-overview-app",
            "retail" or "service_mgmt" => "/erp/jewellery-retail-app",
            "budgeting" => "/erp/budgets-app",
            "fixed_assets" or "asset_mgmt" => "/erp/fixed-assets-app",
            "cost_mgmt" or "cost_acct" => "/erp/cost-models-app",
            "landed_cost_area" => "/erp/landed-cost-app",
            "consolidations" => "/erp/consolidations-app",
            "audit_wb" or "audit" => "/erp/audit-trail-app",
