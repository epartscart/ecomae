...
public static class ErpPhpTabRouteMap
{
    ...
    private static readonly Dictionary<string, string> TabRoutes = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["jw_karat"] = "/cp/jewellery-masters-app?tab=jw_karat",
        ...
        ["jw_purchase_fixing"] = "/cp/jewellery-fixing-app?tab=jw_purchase_fixing",
        ...
        ["jw_repairs"] = "/cp/jewellery-repairs-app?tab=jw_repairs",
        ...
        ["jw_stock_verification"] = "/cp/jewellery-stock-verification-app?tab=jw_stock_verification",
        ...
        ["retail_commerce"] = "/cp/jewellery-retail-app?tab=retail_commerce",
        ["rfid"] = "/erp/rfid-app",
        ["rfq"] = "/erp/rfq-app",
