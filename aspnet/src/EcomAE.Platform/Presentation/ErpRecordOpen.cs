...
public static class ErpRecordOpen
{
    ...
    [
        ...
        "hrt_job_id", "applicant_id", "hrt_review_id",
        "order_id", "pf_case",
        "case_id", "campaign_id",
        "warehouse_id", "rfq_id",
        ...
        "batch_id", "expense_id",
        "expense_report_id", "recon_line_id", "movement_id", "inv_forecast_id", "ncr_id", "pipeline_log_id", "attach_id", "opl_rec_id",
        ...
        "query_id", "block_id", "notif_id", "social_id", "activity_id", "ticket_id", "text_id", "vin_id", "cons_id", "po_req_id", "budget_id", "work_id", "tab_id", "storage_id", "filter_id", "geo_id", "obtaining_mode_id", "content_id", "menu_id", "product_id", "office_id", "module_id", "leg_id", "aprice_id", "ugroup_id", "credit_id", "job_id", "fixing_id", "lead_id", "karat_id", "verify_id", "repair_id", "voc_id", "workflow_id", "tpl_id", "plugin_id", "sm_id", "plist_id", "upload_id",
    ];
