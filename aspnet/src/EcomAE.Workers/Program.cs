...
builder.Services.AddSingleton<ZeroPhpBatchTwoWorkerReplacementCatalog>();
builder.Services.AddSingleton<ZeroPhpBatchTwoWorkerReplacementRunner>();
builder.Services.AddSingleton<ZeroPhpBatchTwoWorkerParityReporter>();
builder.Services.AddSingleton<ZeroPhpBatchTwoWorkerDryRunEvidenceManifest>();
builder.Services.AddSingleton<ZeroPhpBatchTwoWorkerDryRunExecutor>();
builder.Services.AddSingleton<ZeroPhpCutoverBatchCatalog>();
builder.Services.AddSingleton<ZeroPhpCutoverBatchRunner>();
builder.Services.AddSingleton<ZeroPhpCutoverBatchDryRunEvidenceManifest>();
builder.Services.AddSingleton<ZeroPhpCutoverBatchDryRunExecutor>();
builder.Services.AddSingleton<ZeroPhpCutoverBatchParityReporter>();
