...
public sealed class MigrationWorkerJobCatalog
{
    ...
    [
        ...
        new("catalog-miss-fill", "api/umapi_proxy.php / api/v1/catalog.php miss→UMAPI fill", "EcomAE.Workers.CatalogMissFill", "on-demand", "planned", "Simulated miss-fill intents for cacheable actions; outbound UMAPI and cache writes blocked until parity smoke (PHP authoritative)."),
