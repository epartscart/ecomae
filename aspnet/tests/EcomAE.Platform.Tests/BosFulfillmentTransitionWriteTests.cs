...
public sealed class BosFulfillmentTransitionWriteTests
{
    [Fact]
    public void Route_exposes_transition()
    {
        Assert.Equal("/bos/fulfillment/transition", EcomAeRoutes.BosFulfillmentTransition);
    }

    [Fact]
    public void Page_posts_native_transition()
    {
        ...
        Assert.Contains("action=\"/bos/fulfillment/transition\"", razor, StringComparison.Ordinal);
        Assert.Contains("name=\"confirmWrites\"", razor, StringComparison.Ordinal);
        Assert.Contains("value=\"true\"", razor, StringComparison.Ordinal);
        Assert.Contains("name=\"fulfillment_id\"", razor, StringComparison.Ordinal);
        Assert.Contains("name=\"new_status\"", razor, StringComparison.Ordinal);
    ...
    [Fact]
    public void Catalog_marks_transition_live_gated()
    {
        var write = SurfacePayloadContractCatalog.Functions.First(item =>
            item.AspNetRouteOrCapability == "/bos/fulfillment/transition");
        Assert.Equal("write-live-gated", write.Status);
        Assert.Contains("transition", write.Notes, StringComparison.Ordinal);
    ...
    [Fact]
    public void Program_and_module_transition_write()
    {
        var module = File.ReadAllText(Path.Combine(FindRepoRoot(), "aspnet/src/EcomAE.Platform/Modules/BosModule.cs"));
        Assert.Contains("BosFulfillmentTransition", module, StringComparison.Ordinal);
        Assert.Contains("TransitionAsync", module, StringComparison.Ordinal);
        ...
        Assert.Contains("UPDATE `epc_fulfillment_orders`", service, StringComparison.Ordinal);
