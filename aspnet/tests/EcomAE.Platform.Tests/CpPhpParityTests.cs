...
public sealed class CpPhpParityTests
{
    ...
    [InlineData("/CP/shop/finance/epc_subscription_billing", "/erp/sales-orders-app?tab=subscriptions")]
    ...
    [InlineData("/CP/shop/finance/payment_systems", "/cp/payment-gateways-app")]
    [InlineData("/CP/shop/finance/account_operations", "/cp/credit-limits-app")]
