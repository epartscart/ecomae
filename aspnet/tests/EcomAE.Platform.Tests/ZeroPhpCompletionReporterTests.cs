...
public sealed class ZeroPhpCompletionReporterTests
{
    ...
    public void BuildReportQuantifiesRemainingWorkAndBlocksPhpRemoval()
    {
        ...
        Assert.Equal(92, report.OverallCompletePercent);
        Assert.Equal(8, report.OverallPendingPercent);
        ...
        Assert.Contains(report.Areas, area => area.Name == "Route inventory and cutover ownership" && area.CompletePercent == 70);
