...
public sealed class BosEntityEliminateWriteTests
{
    [Fact]
    public void Route_exposes_eliminate()
    {
        Assert.Equal("/bos/entities/eliminate", EcomAeRoutes.BosEntitiesEliminate);
    }

    [Fact]
    public void Page_posts_native_eliminate()
    {
        ...
        Assert.Contains("action=\"/bos/entities/eliminate\"", razor, StringComparison.Ordinal);
    ...
    [Fact]
    public void Catalog_marks_eliminate_live_gated()
    {
        var write = SurfacePayloadContractCatalog.Functions.First(item =>
            item.AspNetRouteOrCapability == "/bos/entities/eliminate");
        Assert.Equal("write-live-gated", write.Status);
        Assert.Contains("eliminate", write.Notes, StringComparison.Ordinal);
    ...
    [Fact]
    public void Program_and_module_eliminate_write()
    {
        var module = File.ReadAllText(Path.Combine(FindRepoRoot(), "aspnet/src/EcomAE.Platform/Modules/BosModule.cs"));
        Assert.Contains("BosEntitiesEliminate", module, StringComparison.Ordinal);
        Assert.Contains("EliminateAsync", module, StringComparison.Ordinal);
        ...
        Assert.Contains("UPDATE `epc_intercompany_txns`", service, StringComparison.Ordinal);
