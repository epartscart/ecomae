...
public sealed class LiveSurfaceLinkReporterTests
{
    ...
    public void BuildReportCataloguesSuperCpTenantAndAspNetDiagnostics()
    {
        ...
        Assert.Equal(207, report.Links.Count(link => link.HostClass == "aspnet-presentation-preview"));
        Assert.Contains(report.Links, link =>
            link.HostClass == "aspnet-presentation-preview"
        ...
        Assert.Contains(report.Links, link =>
            link.HostClass == "aspnet-presentation-preview"
            && link.AspNetRouteHint == "/erp/payables-app");
        Assert.Contains(report.Links, link =>
            link.HostClass == "aspnet-presentation-preview"
        ...
        Assert.Contains(report.Links, link =>
            link.HostClass == "aspnet-presentation-preview"
            && link.AspNetRouteHint == "/erp/inventory-report-app");
        Assert.Contains(report.Links, link =>
            link.HostClass == "aspnet-presentation-preview"
            && link.AspNetRouteHint == "/erp/multi-entity-app");
        Assert.Contains(report.Links, link =>
            link.HostClass == "aspnet-presentation-preview"
