...
public sealed class ErpJwMetalStockWriteServiceTests
{
    ...
    {
        var result = await new ErpJwMetalStockWriteService(new UnusedConnections())
            .SaveAsync(new ErpJwMetalStockSaveRequest(Description: "22K chain"));
