...
public sealed class PhpVsAspNetRemovalMatrixTests
{
    ...
    public void LiveWriteAppsUseNativeFormsNotBlazorHandlers()
    {
        ...
        var cases = new (string File, string Needle)[]
        {
            ...
            ("CpUsersApp.razor", "/cp/users/update"),
            ("CpUsersApp.razor", "/cp/users/delete"),
            ...
            ("CpDesignTokensApp.razor", "/cp/design-tokens/write"),
            ...
            ("BosFleetSummaryApp.razor", "/bos/notifications/mark-read"),
            ("BosFleetSummaryApp.razor", "/bos/notifications/dismiss"),
            ("BosFleetSummaryApp.razor", "/bos/notifications/mark-all-read"),
            ("BosFleetSummaryApp.razor", "/bos/notifications/prefs-save"),
            ("BosFleetSummaryApp.razor", "/bos/notifications/cleanup"),
            ("BosFleetSummaryApp.razor", "/bos/credit/hold"),
            ("BosFleetSummaryApp.razor", "/bos/credit/release"),
            ("BosFleetSummaryApp.razor", "/bos/credit/set-limit"),
            ("BosFleetSummaryApp.razor", "/bos/api-keys/revoke"),
            ("BosFleetSummaryApp.razor", "/bos/webhooks/delete"),
            ("BosFleetSummaryApp.razor", "/bos/webhooks/dlq-resolve"),
            ("BosFleetSummaryApp.razor", "/bos/po/cancel"),
            ("BosFleetSummaryApp.razor", "/bos/po/reject"),
            ("BosFleetSummaryApp.razor", "/bos/po/approve"),
            ("BosFleetSummaryApp.razor", "/bos/fulfillment/pick-item"),
            ("BosFleetSummaryApp.razor", "/bos/fulfillment/transition"),
            ("BosFleetSummaryApp.razor", "/bos/fulfillment/create-wave"),
            ("BosFleetSummaryApp.razor", "/bos/billing/cancel"),
            ("BosFleetSummaryApp.razor", "/bos/billing/pay"),
            ("BosFleetSummaryApp.razor", "/bos/billing/create-plan"),
            ("BosFleetSummaryApp.razor", "/bos/billing/subscribe"),
            ("BosFleetSummaryApp.razor", "/bos/rma/transition"),
            ("BosFleetSummaryApp.razor", "/bos/rma/register"),
            ("BosFleetSummaryApp.razor", "/bos/dealers/auto-tier"),
            ...
            ("BosFleetSummaryApp.razor", "/bos/sandbox/discard"),
            ("BosFleetSummaryApp.razor", "/bos/sandbox/apply-change"),
            ("BosFleetSummaryApp.razor", "/bos/sandbox/create"),
            ("BosFleetSummaryApp.razor", "/bos/marketplace/uninstall"),
            ("BosFleetSummaryApp.razor", "/bos/marketplace/review"),
            ("BosFleetSummaryApp.razor", "/bos/marketplace/install"),
            ("BosFleetSummaryApp.razor", "/bos/industry/assign"),
            ("BosFleetSummaryApp.razor", "/bos/promos/record-usage"),
            ("BosFleetSummaryApp.razor", "/bos/promos/create"),
            ("BosFleetSummaryApp.razor", "/bos/entities/add-member"),
            ("BosFleetSummaryApp.razor", "/bos/entities/intercompany"),
            ("BosFleetSummaryApp.razor", "/bos/entities/eliminate"),
            ("BosFleetSummaryApp.razor", "/bos/payroll/approve-run"),
            ("BosFleetSummaryApp.razor", "/bos/payroll/employee-add"),
            ("BosFleetSummaryApp.razor", "/bos/soc2/add-evidence"),
            ("BosFleetSummaryApp.razor", "/bos/soc2/update-control"),
            ("BosFleetSummaryApp.razor", "/bos/soc2/create-policy"),
            ("BosFleetSummaryApp.razor", "/bos/workflows/toggle"),
            ("BosFleetSummaryApp.razor", "/bos/workflows/delete"),
            ("BosFleetSummaryApp.razor", "/bos/workflows/create"),
            ("BosFleetSummaryApp.razor", "/bos/vault/new-version"),
            ("BosFleetSummaryApp.razor", "/bos/vault/create-folder"),
            ("BosFleetSummaryApp.razor", "/bos/vault/upload"),
            ("BosFleetSummaryApp.razor", "/bos/imports/create"),
