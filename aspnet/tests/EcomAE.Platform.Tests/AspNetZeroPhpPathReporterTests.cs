...
public sealed class AspNetZeroPhpPathReporterTests
{
    ...
    public void BuildReportTargetsAspNetPrimaryPhpReferenceWithoutInventingCutover()
    {
        ...
        Assert.Contains(report.Phases, p => p.Id == "6-php-traffic-fallback-removal" && p.Status == "in-progress");
        ...
        Assert.Contains(report.Notes, n => n.Contains("RELEASE_OWNER_APPROVAL.md", StringComparison.Ordinal));
