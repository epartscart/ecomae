...
public sealed class BosSsoDeleteWriteTests
{
    [Fact]
    public void Route_exposes_delete()
    {
        Assert.Equal("/bos/sso/provider-delete", EcomAeRoutes.BosSsoProviderDelete);
    }
    ...
    public void Page_posts_native_delete()
    {
        ...
        Assert.Contains("action=\"/bos/sso/provider-delete\"", razor, StringComparison.Ordinal);
    ...
    public void Catalog_marks_delete_live_gated()
    {
        var write = SurfacePayloadContractCatalog.Functions.First(item =>
            item.AspNetRouteOrCapability == "/bos/sso/provider-delete");
        Assert.Equal("write-live-gated", write.Status);
        Assert.Contains("provider_delete", write.Notes, StringComparison.Ordinal);
    ...
    public void Program_and_module_delete_write()
    {
        ...
        Assert.Contains("BosSsoProviderDelete", module, StringComparison.Ordinal);
        ...
        Assert.Contains("epc_sso_provider_delete", service, StringComparison.Ordinal);
        Assert.Contains("epc_sso_provider_toggle", service, StringComparison.Ordinal);
        Assert.Contains("DELETE FROM `epc_sso_providers`", service, StringComparison.Ordinal);
