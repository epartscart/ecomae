...
public sealed class BosWorkflowDeleteWriteTests
{
    [Fact]
    public void Route_exposes_delete()
    {
        Assert.Equal("/bos/workflows/delete", EcomAeRoutes.BosWorkflowsDelete);
    }
    ...
    public void Page_posts_native_delete()
    {
        ...
        Assert.Contains("action=\"/bos/workflows/delete\"", razor, StringComparison.Ordinal);
        Assert.Contains("name=\"confirmWrites\"", razor, StringComparison.Ordinal);
        Assert.Contains("value=\"true\"", razor, StringComparison.Ordinal);
        Assert.Contains("name=\"workflow_id\"", razor, StringComparison.Ordinal);
    ...
    public void Catalog_marks_delete_live_gated()
    {
        var write = SurfacePayloadContractCatalog.Functions.First(item =>
            item.AspNetRouteOrCapability == "/bos/workflows/delete");
    ...
    public void Program_and_module_delete_write()
    {
        ...
        Assert.Contains("BosWorkflowsDelete", module, StringComparison.Ordinal);
        ...
        Assert.Contains("epc_workflow_delete", service, StringComparison.Ordinal);
        Assert.Contains("epc_workflow_toggle", service, StringComparison.Ordinal);
        Assert.Contains("DELETE FROM `epc_workflow_steps`", service, StringComparison.Ordinal);
        Assert.Contains("DELETE FROM `epc_workflows`", service, StringComparison.Ordinal);
