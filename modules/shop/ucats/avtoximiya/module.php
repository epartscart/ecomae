...
else//Есть подключение к каталогу
{
	?>
	<div>
		<?php echo translate_str_by_id(4777); ?><br>
	...
	function showProducts()
	{
		...
		for(var i=CurrentPage*Products_per_page; i < Products.length && printed < Products_per_page; i++)
		{
			...
			//Кнопка "Подробнее"
			html += "<div class=\"product_page_button\"><a href=\"<?php echo $multilang_params['lang_href']; ?>/shop/katalogi-ucats/avtoximiya/tovar?tovar="+Products[i].id+"\" class=\"bread_crumbs_a\"><?php echo translate_str_by_id(3608); ?></a></div>";
