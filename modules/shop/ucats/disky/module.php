...
<div style="padding-right:20px;">
	...
	<select id="group_select" onchange="groupChanged();" style="width:100%;" class="form-control">
		<option value="disky_litye"><?php echo translate_str_by_id(4781); ?></option>
		<option value="disky_shtampovannye"><?php echo translate_str_by_id(4782); ?></option>
	</select>
</div>
...
function showProducts()
{
	...
	for(var i=CurrentPage*Products_per_page; i < Products.length && printed < Products_per_page; i++)
	{
		...
		//Кнопка "Подробнее"
		html += "<div class=\"product_page_button\"><a href=\"<?php echo $multilang_params['lang_href']; ?>/shop/katalogi-ucats/kolesnye-diski/tovar?group="+document.getElementById("group_select").value+"&tovar="+Products[i].id+"\" class=\"bread_crumbs_a\"><?php echo translate_str_by_id(3608); ?></a></div>";
