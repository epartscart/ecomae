...
if(!empty($_POST["plugins_action"]))
{
    ...
    for($i=0; $i < count($plugins_list); $i++)
    {
        ...
        {
            //Возникла ошибка
            $warning_message = translate_str_by_id(2739);
            ?>
            <script>
    ...
    if($_POST["plugins_action_type"] == "delete")
    {
        ...
        {
            //Возникла ошибка
            $error_message = translate_str_by_id(2740);
            ?>
            <script>
        ...
        else//Плагины удалены успешно
        {
            ...
            $success_message = translate_str_by_id(2741);
            ?>
            <script>
    ...
    else if($_POST["plugins_action_type"] == "activated")
    {
		...
		for($i=0; $i < count($plugins_list); $i++)
        {
			...
			if($plugins_list[$i] == 10 && $_POST["flag_value"] == 1){
...
else//Действий нет - выводим страницу
{
    ...
    <div class="col-lg-12">
		<div class="hpanel">
			...
			<div class="panel-body">
				...
				<a class="panel_a" onClick="activatePlugins(0, 1);" href="javascript:void(0);">
				...
				<a class="panel_a" onClick="activatePlugins(0, 0);" href="javascript:void(0);">
	...
	<div class="col-lg-12">
		<div class="hpanel">
			<div class="panel-heading hbuilt">
				<?php echo translate_str_by_id(2742); ?>
			</div>
			<div class="panel-body">
					...
					<table cellpadding="1" cellspacing="1" class="table table-condensed table-striped">
						<thead> 
							<tr> 
								...
								<th><?php echo translate_str_by_id(2628); ?></th>
						...
						?>
							<tr>
								<td>
									...
									{
										?>
										<img class="col_img" src="/<?php echo $DP_Config->backend_dir; ?>/templates/<?php echo $DP_Template->name; ?>/images/shield.png" title="<?php echo translate_str_by_id(2743); ?>" />
										<?php
									}
									?>
								</td>
								...
								if($element_record["activated"] == 1)
								{
									...
									{
										$onclick = "alert('".translate_str_by_id(2744)."');";
									}
    ...
    function activatePlugins(plugin, activate_value)
    {
        if(plugin == 0)//Если равно 0 - активируем отмеченные галочками плагины
        {
            ...
            {
                alert("<?php echo translate_str_by_id(2745); ?>");
                return;
            }
        }
    ...
    function deletePlugins(plugin)
    {
        ...
        if(!confirm("<?php echo translate_str_by_id(2746); ?>"))
        {
            return;
        }
