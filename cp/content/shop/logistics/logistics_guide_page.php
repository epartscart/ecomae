...
$include = $_SERVER['DOCUMENT_ROOT'] . '/' . $GLOBALS['DP_Config']->backend_dir . '/content/shop/logistics/logistics_guide.php';
if (!is_file($include)) {
	echo '<div class="alert alert-danger">Logistics guide file not found.</div>';
	return;
}
include $include;
