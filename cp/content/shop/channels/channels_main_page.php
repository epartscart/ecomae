<?php
/**
 * CP route shop/channels/channels — eval-safe wrapper.
 */
...
$include = $_SERVER['DOCUMENT_ROOT'] . '/' . $GLOBALS['DP_Config']->backend_dir . '/content/shop/channels/channels_main.php';
if (!is_file($include)) {
	echo '<div class="alert alert-danger">Channels module not found.</div>';
	return;
}
include $include;
?>
