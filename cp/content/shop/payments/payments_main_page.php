...
$include = $_SERVER['DOCUMENT_ROOT'] . '/' . $GLOBALS['DP_Config']->backend_dir . '/content/shop/payments/payments_main.php';
if (!is_file($include)) {
	echo '<div class="alert alert-danger">Payments module not found.</div>';
	return;
}
include $include;
