<?php
/**
 * Jewellery ERP — Sales Fixing (SFX).
 */
...
erp_page_header('<i class="fa fa-lock"></i> Sales Fixing', 'Lock metal rate on floating sales.', array(
...
?>
<div class="ef-window">
	<div class="ef-title">Sales Fixing - (SFX)</div>
	...
	<div class="ef-body">
		...
		<input type="hidden" name="fix_direction" value="sales">
		...
		<div class="ef-section">
			...
			<div class="ef-row">
				...
				<div class="ef-field"><label>Karat</label><input name="karat" placeholder="22"></div>
			...
			<div class="ef-row">
				<div class="ef-field"><label>Ref. Voucher</label><input name="ref_voucher"></div>
	...
	<div class="ef-status"><span>Mode:=ADD</span><span>Voc Type: SFX — Sales Fixing</span></div>
</div>
