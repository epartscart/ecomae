<?php
/**
 * ERP tab — Print Designer (DIAGNOSTIC — minimal version).
...
?>
<div style="padding:30px;background:#e8f5e9;border:2px solid #4caf50;border-radius:8px;margin:20px;">
	<h3 style="color:#2e7d32;margin-top:0;">Print Designer — Diagnostic</h3>
