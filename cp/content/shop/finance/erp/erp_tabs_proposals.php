...
erp_page_header(
	'<i class="fa fa-file-text"></i> Commercial proposals &amp; proforma',
	'Quotes and proforma invoices — extends CRM quotes. Create and edit in CRM tab.',
	array(
		array('label' => 'ERP', 'url' => epc_erp_tab_url($erpUrl, 'dashboard', $date_from_str, $date_to_str)),
		array('label' => 'Proposals'),
	),
	array(array('label' => 'Open CRM quotes', 'url' => $crmUrl, 'class' => 'btn-primary', 'icon' => 'fa-handshake-o'))
);
erp_stat_cards(array(
	array('label' => 'Total proposals', 'value' => (string) count($quotes)),
...
ob_start();
if (empty($quotes)) {
	erp_empty_state('No proposals yet. Use CRM → Quotes or create from an opportunity.', 'fa-file-text-o');
} else {
...
erp_section_card('Proposal list', ob_get_clean(), array('icon' => 'fa-list'));
