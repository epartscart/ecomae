<?php
/**
 * Full step-by-step ERP guide — CP page wrapper (admin-session gated).
 */
...
if (empty($user_session) || !is_array($user_session)) {
    ...
    echo '<div class="alert alert-warning">Please <a href="' . $login . '">log in to the control panel</a> to view the guide.</div>';
    return;
}

$include = $_SERVER['DOCUMENT_ROOT'] . '/' . $GLOBALS['DP_Config']->backend_dir
    . '/content/shop/finance/erp/erp_full_guide.php';
