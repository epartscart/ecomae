	...
	$epc_erp_nav_cfg = array(
		'overview' => array(
			...
			'tabs' => array(
				...
				'workflow_automation' => array('label' => 'Automation Centre', 'icon' => 'fa-magic'),
			),
			'groups' => array(
				'Workspaces' => array('dashboard', 'workflow', 'processflow'),
				'Governance' => array('approvals'),
				'Automation' => array('workflow_automation'),
			),
		),
		'ap' => array(
		...
		'finance' => array(
			...
			'tabs' => array(
				...
				'accounting_automation' => array('label' => 'Accounting automation', 'icon' => 'fa-magic'),
			...
			'groups' => array(
				...
				'Automation' => array('accounting_automation'),
				'Setup' => array('coa'),
			),
		),
		'people' => array(
		...
		'setup' => array(
			...
			'tabs' => array(
				...
				'workflow_automation' => array('label' => 'Automation Centre', 'icon' => 'fa-magic'),
				'accounting_automation' => array('label' => 'Accounting automation', 'icon' => 'fa-university'),
			),
			'groups' => array(
				'Setup' => array('erp_setup', 'tenant_config'),
				'Security' => array('security_roles'),
				'Platform' => array('platform', 'ai_assistant'),
				'Automation' => array('workflow_automation', 'accounting_automation', 'print_designer'),
