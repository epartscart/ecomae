...
$cmUrl = '/' . $backend . '/users/customer_mgmt';
$cmAjaxUrl = '/' . $backend . '/content/users/ajax_customer_mgmt_endpoint.php';
...
$customers = $tab === 'customers' ? epc_cm_list_customers($db_link, $search) : array();
