...
epc_boc_console_open(array('active' => 'warehouse_control', 'title' => 'Warehouse & Inventory', 'base' => $base, 'operator' => $operatorName, 'env' => 'Production', 'nav' => $nav, 'scope' => 'All units · Fleet'));
